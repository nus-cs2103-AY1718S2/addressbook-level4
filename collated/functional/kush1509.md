...
```
###### /java/seedu/address/logic/commands/job/JobListCommand.java
``` java
...
```
###### /java/seedu/address/logic/commands/job/JobFindCommand.java
``` java
package seedu.address.logic.commands.job;
...
```
###### /java/seedu/address/logic/commands/job/JobEditCommand.java
``` java
package seedu.address.logic.commands.job;
...
```
###### /java/seedu/address/logic/parser/job/JobEditCommandParser.java
``` java
package seedu.address.logic.parser.job;
...
```
###### /java/seedu/address/logic/parser/job/JobFindCommandParser.java
``` java
package seedu.address.logic.parser.job;
...
```
###### /java/seedu/address/model/job/LocationContainsKeywordsPredicate.java
``` java
package seedu.address.model.job;
...
```
###### /java/seedu/address/model/skill/JobSkillContainsKeywordsPredicate.java
``` java
...
```
###### /java/seedu/address/model/skill/SkillMatchesPredicate.java
``` java
package seedu.address.model.skill;
...
<TabPane fx:id="tabPane" prefHeight="400.0" prefWidth="300.0" tabClosingPolicy="UNAVAILABLE" xmlns="http://javafx.com/javafx/9" xmlns:fx="http://javafx.com/fxml/1">
  <tabs>
    ...
    <Tab fx:id="email" text="Draft Email">
      <content>
        <AnchorPane minHeight="0.0" minWidth="0.0" prefHeight="180.0" prefWidth="200.0" />
      </content>
    </Tab>
    <Tab fx:id="googlelogin" text="Google">
      <content>
        <AnchorPane minHeight="0.0" minWidth="0.0" prefHeight="180.0" prefWidth="200.0" />
      </content>
    </Tab>
