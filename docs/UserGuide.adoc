...
image::CodeducatorTitle.png[width:100px]
...
Associate your Google account with Codeducator and authorise Codeducator to upload data to your account's cloud services
