...
* busy university students who has many tasks to keep track of
...
* Natania Djohaari
** Major : Announcement / Notification
*** Helps users be reminded of the latest upcoming deadline
** Minor : Date added parameter
*** Allows users to recall when the task was created
*** Supports application function of priority autoupdating
* Yeo Guek Ling
** Major : Calendar
...
|`* *` |user who is forgetful |have tasks' priority levels be automatically updated when nearing the deadline, or when deadline has passed |be reminded to complete tasks
