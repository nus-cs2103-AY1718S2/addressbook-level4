...
*Add NRIC field in Owner's profile (minor)*

The NRIC field will help the veterinarians and their assistants to better locate an owner using their unique ID.

*Assign different colors to different tags (minor)*

By assigning different colors to different tags, user can differentiate between tags more easily.

*Integrating CalenderFX as framework for Calender view (major)*
