...
* *`list` or `l`* : lists all contacts
* **`add` or `a`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : adds a contact named `John Doe` to the Address Book.
* **`delete` or `d`**`3` : deletes the 3rd contact shown in the current list
* *`exit`* : exits the app
