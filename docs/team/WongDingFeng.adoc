...
This document is prepared to summarise my contributions to the app Flashy.
Flashy is a desktop flashcard management application to help students memorise better.
Flashy is made for CS2103, a Software Engineering module in National University of Singapore(NUS).
