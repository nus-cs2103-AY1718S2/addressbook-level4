...
public class TypicalPersons {
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withEmail("johnd@example.com").withPhone("98765432").withTimeTableLink("http://modsn.us/gka24").withDetail("Likes tennis")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withTimeTableLink(VALID_TIMETABLE_LINK_AMY).withDetail(VALID_DETAIL_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
            .withTimeTableLink(VALID_TIMETABLE_LINK_BOB).withDetail(VALID_DETAIL_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
