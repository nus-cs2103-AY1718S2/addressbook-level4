...
** *What it does:* The autocomplete feature provides suggestions for command words, options, prefixes and parameters in a context menu as the user types. Autocomplete suggestions for options and prefixes come with descriptions to give users an overview of what the option or prefix is used for.
