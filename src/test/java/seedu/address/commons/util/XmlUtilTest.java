...
public class XmlUtilTest {
    ...
    private static final String VALID_AGE = "23";
    private static final String VALID_LATITUDE = "1.352222";
    private static final String VALID_LONGITUDE = "103.981970";
    ...
    public void xmlAdaptedPersonFromFile_fileWithMissingPersonField_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GENDER, VALID_AGE, VALID_LATITUDE
    ...
    public void xmlAdaptedPersonFromFile_fileWithInvalidPersonField_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GENDER,VALID_AGE, VALID_LATITUDE
                , VALID_LONGITUDE, VALID_TAGS);
        assertEquals(expectedPerson, actualPerson);
    }
    ...
    public void xmlAdaptedPersonFromFile_fileWithValidPerson_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GENDER,VALID_AGE, VALID_LATITUDE
                , VALID_LONGITUDE, VALID_TAGS);
        assertEquals(expectedPerson, actualPerson);
    }
