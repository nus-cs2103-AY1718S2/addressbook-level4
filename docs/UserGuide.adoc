...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS nr/NRIC [t/TAG]...` +
or `a n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS nr/NRIC [t/TAG]...`
...
=== Adding an appointment: `appointment` or `aa`

Adds an appointment to Medeina's address book +
Format: `appointment o/OWNER r/REMARK d/DATE [t/TYPE OF APPOINTMENT]...` +
or `aa o/OWNER r/REMARK d/DATE [t/TYPE OF APPOINTMENT]...`

[TIP]
An appointment can have multiple types (checkup + vaccination etc.)

Examples:

* `appointment o/John Doe r/Requires homevisit d/2018-12-31 12:30 t/checkup t/vaccination`
* `aa o/Betsy Crowe r/nil d/2018-12-31 12:30 t/surgery`
