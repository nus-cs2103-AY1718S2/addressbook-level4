...
public class ProcessOrderCommandParserTest {
    ...
    public void parse_invalidArgs_Second_throwsParseException() {
        assertParseFailure(parser, "#", String.format(MESSAGE_INVALID_COMMAND_FORMAT, ProcessOrderCommand.MESSAGE_USAGE));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, ProcessOrderCommand.MESSAGE_USAGE));
    }
}
