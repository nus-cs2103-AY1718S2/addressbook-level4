...
/**
 * Represents a Task's email in the organizer book.
 * Guarantees: immutable; is valid as declared in {@link #isValidEmail(String)}
 */
public class Email {

    private static  final String SPECIAL_CHARACTERS = "!#$%&'*+/=?`{|}~^.-";
    public static final String MESSAGE_EMAIL_CONSTRAINTS = "Task emails should be of the format local-part@domain "
     ...
     *
     * @param email A valid email organizer.
     */
