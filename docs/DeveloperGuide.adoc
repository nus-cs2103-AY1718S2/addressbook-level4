 ...
 ** Users can add profile picture by using `add` command or `edit` command.
 ** Users can view profile picture.

 * How do these features fit into the product scope?
 ** Major Feature: Recruiters have a lot of appointment, meeting, and interviews to manage. Hence, showing them on the calendar help they manage their time effectively.
 ** Minor Feature: Viewing profile pictures of the employees help recruiters to recognize the employees easier.
...
* 3a. The partial word does not match any of the commands known.
+
Use case ends.
