...
****
* Unlock the Employees Tracker with the PASSWORD which match the application's unlock password.
...
* `unlock 123` +
Unlocks Employees Tracker with password: 123 (which is also the application's unlock password)
