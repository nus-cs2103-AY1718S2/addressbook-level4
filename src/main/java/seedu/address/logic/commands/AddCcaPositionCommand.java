 ...
 */
public class AddCcaPositionCommand extends UndoableCommand {

    public static final String COMMAND_WORD = "addccapos";

    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a cca position to the student that you want. "
            + "Parameters: INDEX (must be a positive integer) "
            + PREFIX_CCA_POSITION + "CCA_POSITION\n"
            + "Example: " + COMMAND_WORD + " 1 "
            + PREFIX_CCA_POSITION + "Captain" + "\n";

    public static final String MESSAGE_CCA_POSITION_SUCCESS = "Cca position added: %1$s\nPerson: %2$s";
     ...
     */
    public AddCcaPositionCommand(Index index, EditPersonDescriptor editPersonDescriptor) {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        CcaPosition updatedCcaPosition = parseCcaPosition(((personToEdit.getCcaPosition()).toString() + "\n"
                                            + editPersonDescriptor.getCcaPosition().get().toString()));
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AddCcaPositionCommand)) {
            return false;
        }

        // state check
        AddCcaPositionCommand e = (AddCcaPositionCommand) other;
