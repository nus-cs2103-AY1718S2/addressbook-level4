...
|`* * *` |Student that is finished with a group project |Delete the group tag of a finished group project |Delete the group tag of a finished group project

|`* * *` |Student who forget teammates’ information |I can find out more details of the person such as location, contact number
