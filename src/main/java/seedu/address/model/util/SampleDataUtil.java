...
public class SampleDataUtil {
    public static Patient[] getSamplePersons() {
        return new Patient[] {
            new Patient(new Name("Alex Yeoh"), new Nric("S1234567A"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    new Address("Blk 30 Geylang Street 29, #06-40"), new DateOfBirth("11/11/1991"),
                    new BloodType("A"), new Remark(""), getTagSet("G6PD")),
            new Patient(new Name("Bernice Yu"), new Nric("S7654321B"), new Phone("99272758"), new Email("berniceyu@example.com"),
            ...
            new Patient(new Name("Charlotte Oliveiro"), new Nric("S5671234C"), new Phone("93210283"), new Email("charlotte@example.com"),
                    new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new DateOfBirth("09/09/1989"),
                    new BloodType("A+"), new Remark(""), getTagSet("peanuts")),
            new Patient(new Name("David Li"), new Nric("S3456712D"), new Phone("91031282"), new Email("lidavid@example.com"),
            ...
            new Patient(new Name("Irfan Ibrahim"), new Nric("S5673412E"), new Phone("92492021"), new Email("irfan@example.com"),
                    new Address("Blk 47 Tampines Street 20, #17-35"), new DateOfBirth("07/07/1987"),
                    new BloodType("O"), new Remark(""), getTagSet("ibuprofen")),
            new Patient(new Name("Roy Balakrishnan"), new Nric("S1234512F"), new Phone("92624417"), new Email("royb@example.com"),
