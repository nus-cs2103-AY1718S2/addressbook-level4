...
public class DeleteCommandTest {
    ...
    private Model model = new ModelManager(getTypicalAddressBook(), new UserPrefs(), new UserDatabase(),
            new TestStorage());
    ...
    public void execute_validIndexUnfilteredList_success() throws Exception {
        ...
        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs(), new UserDatabase(),
                new TestStorage());
