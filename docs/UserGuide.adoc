...
+
image:personAdded.png[width="600"] +
...
Adds an event to Fastis and display it on the calendar. +
[blue yellow-background]#*Undoable*# +
Alias: `aE` +
...
+
image:CheckToDoExample.png[width="500"] +
...
Adds 2nd person shown in the person list from group `CS2101 Oral Presentation`.
...
[width="80%",cols="3,10,2,10,3",options="header"]
|=========================================================
