...
public class StatusBarFooter extends UiPart<Region> {
    ...
    @Subscribe
    public void handleCalendarManagerChangedEvent(CalendarManagerChangedEvent cmce) {
        long now = clock.millis();
        String lastUpdated = new Date(now).toString();
        logger.info(LogsCenter.getEventHandlingLogMessage(cmce, "Setting last updated status to " + lastUpdated));
        setSyncStatus(String.format(SYNC_STATUS_UPDATED, lastUpdated));
    }
}
