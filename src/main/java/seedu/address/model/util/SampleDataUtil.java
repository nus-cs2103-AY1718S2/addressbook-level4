    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Nric("S8743880X"), getTagSet("3A"),
                getSubjectSet("English A2"), new Remark("Class Rep"), new Cca("BasketBall : Captain"),
                    new InjuriesHistory(""),
            ...
            new Person(new Name("Mary"), new Nric("S9654654B"),
                getTagSet("5D"), getSubjectSet("HChi A1"), new Remark("Higher Chinese Rep"),
                    new Cca("BasketBall : Captain"), new InjuriesHistory(" "), new NameOfKin("Martha"))
        };
    }
