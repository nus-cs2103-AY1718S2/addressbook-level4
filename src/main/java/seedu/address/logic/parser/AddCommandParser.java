...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            Set<Preference> preferenceList = ParserUtil.parsePreferences(argMultimap.getAllValues(PREFIX_PREFERENCE));

            Person person = new Person(name, phone, email, address, groupList, preferenceList);
