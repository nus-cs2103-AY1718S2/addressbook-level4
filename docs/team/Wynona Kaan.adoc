...
Medeina is a desktop application designed for veterinarians and their assistants to manage their contacts, pet patients and appointments details. Users mainly interact with Medeina using a Command Line Interface (CLI), and it has a Graphical User Interface (GUI) created with JavaFX so that users can visualise the data easily. It is written in Java, and has about 20 kLoC.
...
** Documentation
*** Improved user-friendliness in the User Guide by adding prefaces. (Pull request https://github.com/CS2103JAN2018-F14-B2/main/pull/79[#79])
*** Touched up on `v2.0` upcoming functions in the User Guide. (Pull request https://github.com/CS2103JAN2018-F14-B2/main/pull/79[#79])
