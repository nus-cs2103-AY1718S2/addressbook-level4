...
public class Messages {
    ...
    public static final String MESSAGE_RECIPES_WITH_TAGS_LISTED_OVERVIEW = "%d recipes with tag(s) \"%s\" listed!";
    public static final String MESSAGE_RECIPES_WITH_INGREDIENTS_LISTED_OVERVIEW = "$d recipes with ingredient(s) "
            + "\"%s\" listed!";
