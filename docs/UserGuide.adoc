...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 g/M lat/1.2345 lon/5.4321` : adds a customer named `John Doe` to Retail Analytics.
...
Adds a person to Retail Analytics +
...
=== Visulising locations of all persons in a map: `map`
