...
import static seedu.flashy.logic.parser.CliSyntax.PREFIX_DAY;
import static seedu.flashy.logic.parser.CliSyntax.PREFIX_FRONT;
import static seedu.flashy.logic.parser.CliSyntax.PREFIX_MONTH;
...
import static seedu.flashy.logic.parser.CliSyntax.PREFIX_YEAR;
...
public class CommandTestUtil {
     ...
     * - the flashy book and the filtered tag list in the {@code actualModel} remain unchanged
     */
    ...
    /**
     * Deletes the first tag in {@code model}'s filtered list from {@code model}'s flashy book.
     */
