    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            Person person = new Person(name, phone, email, address, expectedGraduationYear,
                    major, gradePointAverage, rating, resume, interviewDate, status, tagList);
