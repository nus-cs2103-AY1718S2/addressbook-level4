...
public class FindCommandTest {
    ...
    public void execute_multipleKeywords_multipleStudentsFound() {
        String expectedMessage = String.format(MESSAGE_STUDENT_LISTED_OVERVIEW, 3);
     ...
     */
    private void assertCommandSuccess(FindCommand command, String expectedMessage, List<Student> expectedList) {
