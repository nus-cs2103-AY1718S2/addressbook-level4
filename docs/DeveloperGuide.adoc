...
[discrete]
=== Use case: Generate a pdf report of a pet patient's medical history and owner's contact information (for transfer to another vet clinic)
...
* 3a. The given tag(s) is/are invalid.
+
[none]
** 3a1. AddressBook shows a list of valid tags.
+
Use case resumes at step 2.
