...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Recipe expectedRecipe =
            new RecipeBuilder().withName(VALID_NAME_BOB).withPreparationTime(VALID_PREPARATION_TIME_BOB)
                .withIngredient(VALID_INGREDIENT_BOB).withInstruction(VALID_INSTRUCTION_BOB).withTags(VALID_TAG_FRIEND)
                .build();
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser,
            VALID_NAME_BOB + PREPARATION_TIME_DESC_BOB + INGREDIENT_DESC_BOB + INSTRUCTION_DESC_BOB, expectedMessage);

        // missing preparationTime prefix
        assertParseFailure(parser,
            NAME_DESC_BOB + VALID_PREPARATION_TIME_BOB + INGREDIENT_DESC_BOB + INSTRUCTION_DESC_BOB, expectedMessage);

        // missing ingredient prefix
        assertParseFailure(parser,
            NAME_DESC_BOB + PREPARATION_TIME_DESC_BOB + VALID_INGREDIENT_BOB + INSTRUCTION_DESC_BOB, expectedMessage);

        // missing recipe prefix
        assertParseFailure(parser,
            NAME_DESC_BOB + PREPARATION_TIME_DESC_BOB + INGREDIENT_DESC_BOB + VALID_INSTRUCTION_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PREPARATION_TIME_DESC_BOB
                + INGREDIENT_DESC_BOB + INSTRUCTION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
