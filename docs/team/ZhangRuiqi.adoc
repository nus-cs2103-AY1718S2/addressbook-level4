...
** Justification: Allowing the target users of this app - loan shark managers, to know where their customers are important because it's cost- and time- efficient to assign the customers to the nearest runners.
