...
public class HelpCommandSystemTest extends AddressBookSystemTest {
    ...
    public void openHelpWindow() {
        ...
        //will be implemented when default screen for contact details panel is added
        ...
        assertNotEquals(BrowserPanel.DEFAULT_PAGE_URL, getBrowserPanel().getLoadedUrl().toString());
