...
=== Search for profile on Facebook : `searchfb` `[Since v1.4]`

Search for the specified profiles on Facebook. +
Format: `searchfb KEYWORD`

****
* The KEYWORD is the name to be searched on Facebook.
* Make use of the search engine of Facebook.
* Dummy SearchPage is used currently, actual link to search result will come in v1.5.
****
...
=== Search for profile on Twitter : `searchtwitter` `[Since v1.4]`

Search for the specified profiles on Twitter. +
Format: `searchtwitter KEYWORD`

****
* The KEYWORD is the name to be searched on Twitter.
* Make use of the search engine of Twitter.
* Dummy SearchPage is used currently, actual link to search result will come in v1.5.
****
