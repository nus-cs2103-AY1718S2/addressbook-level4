...
Each of the four components `UI`, `Logic`, `Model`, `Storage`
...
The _Sequence Diagram_ below shows how the components interact in the scenario where the user issues the command `delete 1`.
