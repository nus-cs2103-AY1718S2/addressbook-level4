...
public class StatusBarFooterHandle extends NodeHandle<Node> {
    ...
    private static final String NUMBER_OF_PEOPLE_ID = "#numberOfPeopleStatus";
    ...
    public StatusBarFooterHandle(Node statusBarFooterNode) {
        ...
        this.numberOfPeopleNode = getChildNode(NUMBER_OF_PEOPLE_ID);
    }
    ...
    /**
     * Remembers the content of the 'number of people' portion of the status bar.
     */
    public void rememberNumberOfPeople() {
        lastRememberedNumberOfPeople = getNumberOfPeople();
    }

    /**
     * Returns true if the current content of the 'number of people' is different from the value remembered by the most
     * recent {@code rememberNumberOfPeople()} call.
     */
    public boolean isNumberOfPeopleChanged() {
        return !lastRememberedNumberOfPeople.equals(getNumberOfPeople());
    }
}
