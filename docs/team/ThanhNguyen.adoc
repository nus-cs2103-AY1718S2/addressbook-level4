...
ifdef::env-github[]
Please click https://recirecipe.netlify.com/team/ThanhNguyen.html[here] to view my project portfolio with full formatting.
---
endif::[]

[.print-only]
Please visit the https://recirecipe.netlify.com/team/ThanhNguyen.html[online page] to view my project portfolio with full formatting.
...
** Rewrote the UG for non-tech users, added manual testing (PR link:https://github.com/CS2103JAN2018-F09-B2/main/pull/161[#161]).
