...
public class XmlSerializableAddressBookTest {
    ...
    private static final File TYPICAL_JOBS_FILE = new File(TEST_DATA_FOLDER + "typicalJobsAddressBook.xml");
    private static final File INVALID_PERSON_FILE = new File(TEST_DATA_FOLDER + "invalidPersonAddressBook.xml");
    private static final File INVALID_JOB_FILE = new File(TEST_DATA_FOLDER + "invalidPersonAddressBook.xml");
    ...
    public void toModelType_invalidJobFile_throwsIllegalValueException() throws Exception {
        XmlSerializableAddressBook dataFromFile = XmlUtil.getDataFromFile(INVALID_JOB_FILE,
                XmlSerializableAddressBook.class);
        thrown.expect(IllegalValueException.class);
        dataFromFile.toModelType();
    }
