...
public class XmlAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_ORDER, VALID_EMAIL,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(null, VALID_PHONE, VALID_ORDER, VALID_EMAIL,
                VALID_ADDRESS, VALID_HALAL, VALID_VEGETARIAN, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_ORDER, VALID_EMAIL,
                        VALID_ADDRESS, VALID_HALAL, VALID_VEGETARIAN, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, null, VALID_ORDER, VALID_EMAIL,
                VALID_ADDRESS, VALID_HALAL, VALID_VEGETARIAN, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_ORDER, INVALID_EMAIL,
                        VALID_ADDRESS, VALID_HALAL, VALID_VEGETARIAN, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_ORDER, null,
                VALID_ADDRESS, VALID_HALAL, VALID_VEGETARIAN, VALID_TAGS);
