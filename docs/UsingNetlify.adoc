...
https://www.netlify.com/[Netlify, window="_blank"] is an automated hosting platform for deploying static websites.
With the aid of build tools such as Gradle, Netlify provides a smoother experience for previewing documentation.
This can be done by using Netlify's https://www.netlify.com/blog/2016/07/20/introducing-deploy-previews-in-netlify/[Deploy Previews, window="_blank"] feature,
...
+
. Go to https://www.netlify.com/[https://www.netlify.com/, window="_blank"] and click `Sign Up`. Next, click `GITHUB SIGN IN`, enter your GitHub account details and authorize netlify.
+
...
+
image:netlify/grant_or_request_access.png[Grant or request access]
