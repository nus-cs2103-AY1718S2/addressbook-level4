...
+
This is because contactHeRo has to use the login information from the webpage after you have login to send email.
...
[NOTE]
Please do not go to any other webpage in the `Google` tab after you have logged in.
...
*Important*: You must have logged in to Google using `googlelogin`. Otherwise, you will not be able to send out emails.
...
* *NOTE*: Please ensure that you have internet connection before sending the email!
****
