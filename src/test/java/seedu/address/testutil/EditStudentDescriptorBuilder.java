...
public class EditStudentDescriptorBuilder {
    ...
    /**
     * Sets the {@code programminglanguage} of the {@code EditStudentDescriptor} that we are building.
     */
    public EditStudentDescriptorBuilder withProgrammingLanguage(String progLanguage) {
        descriptor.setProgrammingLanguage(new ProgrammingLanguage(progLanguage));
        return this;
    }
