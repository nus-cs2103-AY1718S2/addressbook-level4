...
** Justification: User can delete obsolete information. User does not need to delete every dependency manually, but can just use the force option to immediately delete all dependencies.
