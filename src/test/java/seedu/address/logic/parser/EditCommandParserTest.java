...
public class EditCommandParserTest {
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased()  + PHONE_DESC_AMY + ADDRESS_DESC_AMY
                ...
                + EMAIL_DESC_BOB + EXPECTED_GRADUATION_YEAR_DESC_AMY
                + MAJOR_DESC_AMY + GRADE_POINT_AVERAGE_DESC_AMY + TAG_DESC_HUSBAND;
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC
                ...
                + GRADE_POINT_AVERAGE_DESC_BOB + MAJOR_DESC_BOB;
        descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                ...
                .withGradePointAverage(VALID_GRADE_POINT_AVERAGE_BOB).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
