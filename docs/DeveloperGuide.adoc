...
|Xin Hui |Subject Window: Work with subject class and add support for calculations and input  | Subject Class Database: Create subject class and integrate input into command.
...
|`* * *` |teacher with many students |find a student by name |retrieve details of a student without having to go through the entire list
...
1.  User requests to list or find persons
2.  AddressBook shows a list of persons
3.  User requests to add an appointment for a specific person in the list
4.  User inputs the selected date and time for the appointment
5.  AddressBook shows the updated details of the appointment
+
Use case ends.
...
* 4a. The given date or time is invalid.
+
[none]
...
* 4b. The given date or time is already booked by another appointment.
+
[none]
** 4b1. AddressBook prompts user to input another date or time.
+
Use case resumes at step 3.
