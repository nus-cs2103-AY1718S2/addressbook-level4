...
* You will be shown a list of suggested NRICs when when you need to reference an existing contact in Medeina e.g. adding a pet patient or appointment, and editing a pet patient to change point of contact.
