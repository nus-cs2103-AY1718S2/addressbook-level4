...
|`* * *` |user with many contacts |remove a specific tag |all contacts with that tag will have the tag removed instead of removing the tag from from every one of them |1.1

|`* * *` |user with many contacts |find contacts based on the group they are in |see all contacts belonging to a certain group |1.1
...
|`* * *` |salesperson |add a list of preferences to contact |know what my customers are interested in |2.0

|`* * *` |salesperson |edit contact’s preferences |update my customers' changing interests |2.0
