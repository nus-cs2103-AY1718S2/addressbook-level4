...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        String rawCommand = "     " + DeleteCommand.COMMAND_WORD + "      " + INDEX_FIRST_PERSON.getOneBased() + "       ";
     ...
     */
    private void assertCommandSuccess(String command, Model expectedModel, String expectedResultMessage, Index expectedSelectedCardIndex) {
