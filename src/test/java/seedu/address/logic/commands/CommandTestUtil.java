...
public class CommandTestUtil {
    ...
    public static final String VALID_COMMENT_AMY = "NIL";
    public static final String VALID_COMMENT_BOB = "NIL";
    ...
    public static final String BLANK_TIMEZONE_DESC = " " + PREFIX_TIMEZONE; //empty string not allowed for timezones
    public static final String INVALID_TIMEZONE_DESC = " " + PREFIX_TIMEZONE + "P$T"; //random string not allowed for timezones
