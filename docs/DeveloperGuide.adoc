...
We implement Model#deleteTag(Tag) torwards the direction of removeTag command, so that the developer dealing with the 'logic' component is able to implement such a command.
...
==== Gloria Law
* *Major*: A chat bot which the sales person can ask simple questions regarding his schedule and clients.
...
* *Minor*: A remove tag method in model component.
