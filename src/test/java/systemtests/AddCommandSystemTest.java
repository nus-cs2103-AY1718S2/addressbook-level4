...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        /* Case: add a person without preferences or groups to a non-empty address book,
         * command with leading spaces and trailing spaces -> added
         */
        Person toAdd = AMY;
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + PHONE_DESC_AMY + " "
                + EMAIL_DESC_AMY + "   " + ADDRESS_DESC_AMY + "   " + GROUP_DESC_FRIEND + PREFERENCE_DESC_SHOES;
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withGroups(VALID_GROUP_FRIEND)
                .withPreferences(VALID_PREFERENCE_SHOES).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + GROUP_DESC_FRIEND + PREFERENCE_DESC_SHOES;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_BOB).withGroups(VALID_GROUP_FRIEND)
                .withPreferences(VALID_PREFERENCE_SHOES).build();
        ...
        /* Case: invalid preferences -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
