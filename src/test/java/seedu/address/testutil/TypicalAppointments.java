...
public class TypicalAppointments {
    ...
    public static final Appointment ALLY = new AppointmentBuilder().withOwner("Ally Lee")
            .withRemark("Requires Home Visit").withDateTime("2018-12-31 12:30")
            .withTags("checkup").build();
    public static final Appointment BENNY = new AppointmentBuilder().withOwner("Benny Lee")
