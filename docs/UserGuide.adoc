...
Format: `addappt INDEX DATE TIME` or `aa PATIENT_NAME DATE TIME`
...
`viewappt` +
Adds a medical appointment for the first person in the list on 19/3/2018 at 10am as shown in Figure 10.
...
Format: `viewappt INDEX` or `va INDEX`
...
* `viewappt 1` +
Lists the medical appointments made by the first patient in the list as shown in Figure 11.
...
Format: `delappt INDEX DATE TIME` or `da INDEX DATE TIME`
...
Deletes the medical appointment on 19/6/2018 12pm made by the first patient in the list as shown in Figure 13.
