 ...
 */
public interface Storage extends AddressBookStorage, CalendarManagerStorage, UserPrefsStorage {
    ...
    /**
     * Saves the current version of the Calendar Manager to the hard disk.
     *   Creates the data file if it is missing.
     * Raises {@link DataSavingExceptionEvent} if there was an error during saving.
     */
    void handleCalendarManagerChangedEvent(CalendarManagerChangedEvent cmce);
}
