...
=== Importing contacts from CSV : `import_contacts`

Will import contacts from a csv file that contains the header (Name, Email, Phone, Address) +
Format: `import_contacts User/username/examplefile.csv`
