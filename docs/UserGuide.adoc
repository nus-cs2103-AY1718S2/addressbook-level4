...
e.g. `add n/Animal Farm a/George Orwell i/9780736692427 av/Borrowed and Reserved t/political t/satire`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
...
e.g. `reserve 2`
* *addAccount* : `addAccount n/NAME m/MATRICNUMBER u/USERNAME p/PASSWORD l/PRIVILEGE LEVEL` +
