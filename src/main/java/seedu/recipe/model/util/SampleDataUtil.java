...
public class SampleDataUtil {
    public static Recipe[] getSampleRecipes() {
        return new Recipe[] {
            new Recipe(new Name("Alex Yeoh"), new PreparationTime("87438807"), new Ingredient("alexyeoh@example.com"),
                new Instruction("Blk 30 Geylang Street 29, #06-40"),
                getTagSet("friends")),
            new Recipe(new Name("Bernice Yu"), new PreparationTime("99272758"), new Ingredient("berniceyu@example.com"),
                new Instruction("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends")),
            new Recipe(new Name("Charlotte Oliveiro"), new PreparationTime("93210283"), new Ingredient("charlotte@example.com"),
                new Instruction("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("neighbours")),
            new Recipe(new Name("David Li"), new PreparationTime("91031282"), new Ingredient("lidavid@example.com"),
                new Instruction("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family")),
            new Recipe(new Name("Irfan Ibrahim"), new PreparationTime("92492021"), new Ingredient("irfan@example.com"),
                new Instruction("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates")),
            new Recipe(new Name("Roy Balakrishnan"), new PreparationTime("92624417"), new Ingredient("royb@example.com"),
