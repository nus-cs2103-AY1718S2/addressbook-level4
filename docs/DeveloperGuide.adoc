...
We have created `Building`, `Room`, `Week`, and `WeekDay` to read and store all weekday schedule of all NUS Rooms.

The following architecture diagram shows the logic and storage component:
