...
*** Wrote additional tests for added features e.g. Halal and Vegetarian features (Pull requests https://github.com/CS2103JAN2018-F11-B4/main/commit/03012e1ab2bcd39acf06190b2ff3f6b4a7267863[#29])
** Documentation:
...
include::../DeveloperGuide.adoc[tag=identify]
