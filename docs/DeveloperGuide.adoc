...
. Run the `seedu.progresschecker.MainApp` and try a few commands
...
. (Minor) Implement dynamic search and highlight keywords which are being searched
...
|`* *` |user |upload a profile picture |help others to recognize me
...
2.  ProgressChecker shows a list of persons
3.  User requests to delete a specific person in the list
4.  ProgressChecker deletes the person
+
Use case ends.
...
2.  ProgressChecker shows tasks in the specified week
3.  User requests to add a new task in a specific week
4.  ProgressChecker adds a new task to the existing list
+
Use case ends.
...
4.  ProgressChecker marks specified task as complete
+
Use case ends.
