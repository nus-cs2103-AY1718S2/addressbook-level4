= E.T. (Employee Tracker) - Developer Guide
:toc:
:toc-title:
...
=== Every employee has own timetable
...
2. EmployeeTracker shows a list of employees
3. User requests to add a entry to an employee's timetable
4. EmployeeTracker adds the entry
+
Use case ends.
...
+
[none]
** 3a1. EmployeeTracker shows an error message.
+
...
4. EmployeeTracker add the rating
...
+
[none]
** 3b1. EmployeeTracker shows an error message.
+
Use case resumes at step 2.
...
+
[none]
** 4a1. EmployeeTracker updates the rating for the person with the new rating.
+
Use case ends.
...
3. EmployeeTracker sorts the employees in the list by their ratings
4. EmployeeTracker shows the sorted list
+
Use case ends.
...
2. EmployeeTracker shows a list of all employees
3. User requests to add timetable entry to many employees
4. EmployeeTracker add the entry to many employees
+
Use case ends.
...
4. EmployeeTracker add the review to the employee
+
Use case ends.
...
[discrete]
=== Use Case: Export EmployeeTracker

*MSS*

1. User requests export EmployeeTracker into a directory
2. EmployeeTracker export the EmployeeTracker data in a file to the directory specified
+
Use case ends.
...
+
[none]
** 1a1. EmployeeTracker shows an error message.
+
Use case ends.

[discrete]
=== Use Case: Import EmployeeTracker

*MSS*

1. User requests import EmployeeTracker file from a directory
2. EmployeeTracker import the EmployeeTracker data from the file in the directory specified
+
Use case ends.
...
3. EmployeeTracker shows the timetable of that person.
4. User requests to update the information of an entry in the timetable.
5. EmployeeTracker updates the new information for that timetable entry.
+
Use case ends.
...
+
[none]
** 2a1. EmployeeTracker shows an error message.
+
Use case resumes at step 2.
...
+
[none]
** 4a1. EmployeeTracker shows an error message
+
Use case resumes at step 2.

* 4b. The new information given by user doesn't follow command format
[none]
** 4b1. EmployeeTracker shows an error message

** Use case resumes at step 2.

* 5a. EmployeeTracker couldn't write to save file.
[none]
** 5a1. EmployeeTracker shows error message and requests user to resolve the error.
...
5. EmployeeTracker deletes the timetable entry.
+
Use case ends.
...
3. EmployeeTracker opens up a webpage for composing email to that person.
+
Use case ends.
...
[none]
** 3a1. EmployeeTracker shows error message.
** Use case ends.
...
3. EmployeeTracker exports the list of persons as excel sheet.
+
Use case ends.
...
** 2a1. EmployeeTracker shows an error message.
** Use case resumes at step 2.
* 3a. EmployeeTracker couldn't write to save file.
[none]
** 3a1. EmployeeTracker shows error message and requests user to resolve the error.
...
1. User starts the EmployeeTracker program.
2. EmployeeTracker requests user to enter username and password.
3. User enters his username and password
4. EmployeeTracker shows the content.
+
Use case ends.
...
2. EmployeeTracker is locked unless user unlocks it.
[none]
...
2. EmployeeTracker unlocked. Use case ends.
...
4. EmployeeTracker changes the rating of the employee.
+
Use case ends.
...
2. EmployeeTracker changes the scheme/theme/skin
+
Use case ends.
