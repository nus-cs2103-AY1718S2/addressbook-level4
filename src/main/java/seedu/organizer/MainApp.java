...
import seedu.organizer.commons.core.Version;
...
import seedu.organizer.commons.util.ConfigUtil;
import seedu.organizer.commons.util.StringUtil;
import seedu.organizer.logic.Logic;
import seedu.organizer.logic.LogicManager;
...
import seedu.organizer.storage.StorageManager;
import seedu.organizer.storage.UserPrefsStorage;
import seedu.organizer.storage.XmlOrganizerStorage;
import seedu.organizer.ui.Ui;
import seedu.organizer.ui.UiManager;
...
public class MainApp extends Application {
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty Organizer");
            initialData = new Organizer();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting Organizer " + MainApp.VERSION);
