...
public class EditCommandTest {
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() {
        EditCommand editCommand = prepareCommand(INDEX_FIRST_BOOK, new EditPersonDescriptor());
        Person editedPerson = model.getFilteredPersonList().get(INDEX_FIRST_BOOK.getZeroBased());
    ...
    public void execute_filteredList_success() throws Exception {
        ...
        Person personInFilteredList = model.getFilteredPersonList().get(INDEX_FIRST_BOOK.getZeroBased());
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        Person firstPerson = model.getFilteredPersonList().get(INDEX_FIRST_BOOK.getZeroBased());
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        Person personInList = model.getAddressBook().getPersonList().get(INDEX_SECOND_BOOK.getZeroBased());
        EditCommand editCommand = prepareCommand(INDEX_FIRST_BOOK,
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        Person editedPerson = new PersonBuilder().build();
        Person personToEdit = model.getFilteredPersonList().get(INDEX_FIRST_BOOK.getZeroBased());
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(editedPerson).build();
        EditCommand editCommand = prepareCommand(INDEX_FIRST_BOOK, descriptor);
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new UserPrefs());
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonEdited() throws Exception {
        ...
        expectedModel.updatePerson(personToEdit, editedPerson);
        assertNotEquals(model.getFilteredPersonList().get(INDEX_FIRST_BOOK.getZeroBased()), personToEdit);
