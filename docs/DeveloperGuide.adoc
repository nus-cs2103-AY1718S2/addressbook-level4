...
`CommandBox`, `ResultDisplay`, `PersonListPanel`, `ToDoListPanel`, `GroupListPanel`, `Calendar`, `TimeTable`, `StatusBarFooter`, `ProgessIndicatorProperty`, `BrowserPanel`.All these, including the `MainWindow`, inherit from the abstract `UiPart` class. +
