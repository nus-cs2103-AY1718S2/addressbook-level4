...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS b/BIRTHDAY [d/APPOINTMENT] [t/TAG] [i/INSURANCE] [g/GROUP] ...` Alias: `a`

[TIP]
A person can have any number of tags, appointment and insurance plans (including 0)

Examples:

* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 b/09-12-1994 i/health g/family`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 b/29-10-1992 g/friends t/criminal`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY] [d/APPOINTMENT] [t/TAG]...` Alias: `e`
...
* As of v1.2, the application only handles the command for the portfolio. The actual export of the data files of the calendar will come in v2.0.
* Default destination file is at `data/portfolio.csv` for the `export portfolio` command.
====
