...
* *Code contributed*: [https://github.com/CS2103JAN2018-W09-B3/main/blob/master/collated/functional/chweeee.md[Functional code]] [https://github.com[Test code]]
...
** Documentation:
*** Tweaked writing style of the User Guide to make it more personal to the user.
...
include::../DeveloperGuide.adoc[tag=a]
