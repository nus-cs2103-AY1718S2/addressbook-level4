...
. Notification panel: where hidden notification cards are stored
...
=== Hiding a notification : `hide 1`

Hides the notification card identified by the index number used in notification cards. +
Format: `hide INDEX`

[NOTE]
The hidden notification card will be stored in the notification panel.
...
Shows the notification panel if it is hidden; hides the notification panel if it is shown. +
Format: `noti`
