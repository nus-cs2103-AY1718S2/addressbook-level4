...
*** Managed the Issue Tracker, assigned issues and added labels to the issues.
*** Help resolve merge conflicts.
*** Set up Travis for the organization repo.
*** Help update README (PR https://github.com/CS2103JAN2018-F09-B1/main/pull/66[#66]), changed application icon and name.
** Documentation:
*** Updated the screenshots used in the User Guide: https://github.com/CS2103JAN2018-F09-B1/main/pull/57[#57]
*** Edited the developer guide for english, added prefaces, updated images, made explanations clearer and added manual testing cases.
** Community:
