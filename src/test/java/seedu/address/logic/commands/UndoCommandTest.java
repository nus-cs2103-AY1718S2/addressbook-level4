...
public class UndoCommandTest {
    ...
    private final DeleteCommand deleteCommandTwo = new DeleteCommand(INDEX_FIRST_STUDENT);
    ...
    public void execute() throws Exception {
        ...
        Model expectedModel = new ModelManager(getTypicalAddressBook(), new UserPrefs(), new Schedule());
