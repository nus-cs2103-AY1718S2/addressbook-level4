...
public class TimetableEntryTimeParserUtil {
    ...
    private static final int SINGAPORE_TIMEZONE_OFFSET = 8;
    ...
    public static TimetableEntryTime parseTime(String input) {
        return new TimetableEntryTime(Integer.parseInt(input.substring(YEAR_BEGIN_INDEX, YEAR_END_INDEX)),
                Integer.parseInt(input.substring(MONTH_BEGIN_INDEX, MONTH_END_INDEX)),
                Integer.parseInt(input.substring(DAY_BEGIN_INDEX, DAY_END_INDEX)),
                Integer.parseInt(input.substring(HOUR_BEGIN_INDEX, HOUR_END_INDEX)) + SINGAPORE_TIMEZONE_OFFSET,
