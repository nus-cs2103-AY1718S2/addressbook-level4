...
|Tan Wei Jie
a|
* Add person from social media friends list function:
** Allows user to perform the `add` command by obtaining the relevant information stated in his/her friend's social
media page.
This feature eases the process of having to manually key in all the required information before a user can add a
