...
public class SampleDataUtil {
    public static Recipe[] getSampleRecipes() {
        return new Recipe[] {
            new Recipe(new Name("Alex Yeoh"), new Ingredient("alexyeoh@example.com"),
                    new Instruction("Blk 30 Geylang Street 29, #06-40"), ,
                    new PreparationTime("87438807"), ,
                    ,
                    new Url("https://www.allrecipes.com/recipe/73634/colleens-slow-cooker-jambalaya/"),
                    getTagSet("friends")),
            new Recipe(new Name("Bernice Yu"), new Ingredient("berniceyu@example.com"),
                    new Instruction("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), ,
                    new PreparationTime("99272758"), ,
                    ,
            ...
            new Recipe(new Name("Charlotte Oliveiro"), new Ingredient("charlotte@example.com"),
                    new Instruction("Blk 11 Ang Mo Kio Street 74, #11-04"), ,
                    new PreparationTime("93210283"), ,
                    ,
            ...
            new Recipe(new Name("David Li"), new Ingredient("lidavid@example.com"),
                    new Instruction("Blk 436 Serangoon Gardens Street 26, #16-43"), ,
                    new PreparationTime("91031282"), ,
                    ,
                    ...
                    getTagSet("family")),
            new Recipe(new Name("Irfan Ibrahim"), new Ingredient("irfan@example.com"),
                    new Instruction("Blk 47 Tampines Street 20, #17-35"), ,
                    new PreparationTime("92492021"), ,
                    ,
            ...
            new Recipe(new Name("Roy Balakrishnan"), new Ingredient("royb@example.com"),
                    new Instruction("Blk 45 Aljunied Street 85, #11-31"), ,
                    new PreparationTime("92624417"), ,
                    ,
