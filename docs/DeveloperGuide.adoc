...
. Fix `invalidAndValidPersonAddressBook.xml`, `typicalPersonsRecipeBook.xml`, `validAddressBook.xml` etc., such that the XML tests will not fail due to a missing `<remark>` element.
