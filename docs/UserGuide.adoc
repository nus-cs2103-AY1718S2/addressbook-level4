...
[TIP]
You can include the delivery date for a person when adding them to the address book

Examples:

* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 d/2018-06-2`
