...
Bibliotek is a free book cataloguing application. It is targeted at heavy readers who require a hassle-free way of managing and keeping track of their read and unread books.
...
** Credits: the HTTP request is made using the https://github.com/AsyncHttpClient/async-http-client[AsyncHttpClient, window="_blank"] library,
and parsing of JSON results are accomplished with the help of the https://github.com/FasterXML/jackson[Jackson, window="_blank"] library.
...
** Community:
*** PRs reviewed (with non-trivial review comments): [link:{repoURL}/pull/66[#66]], [link:{repoURL}/pull/72[#72]], [link:{repoURL}/pull/86[#86]], [link:{repoURL}/pull/111[#111]], [link:{repoURL}/pull/138[#138]], [link:{repoURL}/pull/155[#155]]
...
*** Integrated TravisCI, AppVeyor, Coveralls, Codacy, and Netlify to the team repo
*** Integrated a new Github plugin (CircleCI) to the team repo
*** Changed build configuration to allow running JUnit tests in parallel: [link:{repoURL}/pull/96[#96]]
