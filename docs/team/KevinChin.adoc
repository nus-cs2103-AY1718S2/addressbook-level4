...
** Justification: As we all know, recruiters will usually send out emails to potential employees to inform them of their job application progress or arranging for interview.
