...
* *(Major)* Create a unique log for each student storing tuition progress and displaying functionalities for the log
** This helps the tutor keep track of what was covered in the previous tuition session as well as homework given and remarks if any.
...
** This makes the app more user-friendly without the need to memorise syntax of commands and able to execute commands more intuitively
