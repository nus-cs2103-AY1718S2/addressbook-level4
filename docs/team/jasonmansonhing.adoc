...
** Documentation:
*** : Wrote most of the user stories in the Developer Guide https://github.com[#14]
*** : Added 6 use cases to the Developer Guide https://github.com[#14]
*** : Defined most of the NFRs for the Developer Guide https://github.com[#14]
** Community:
