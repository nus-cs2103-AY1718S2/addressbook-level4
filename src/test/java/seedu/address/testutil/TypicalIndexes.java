...
public class TypicalIndexes {
    ...
    public static final Index INDEX_FIRST_PETPATIENT = Index.fromOneBased(1);
    public static final Index INDEX_SECOND_PETPATIENT = Index.fromOneBased(2);
    public static final Index INDEX_THIRD_PETPATIENT = Index.fromOneBased(3);
