...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                + PHONE_DESC_BOB + " " + EMAIL_DESC_BOB + "  " + ADDRESS_DESC_BOB + " " + CURRENT_POSITION_DESC_BOB
                + COMPANY_DESC_BOB + " " + PROFILE_PICTURE_DESC_BOB + " " + SKILL_DESC_HUSBAND + " ";
        Person editedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                ...
                .withProfilePicture(VALID_PROFILE_PICTURE_BOB).withSkills(VALID_SKILL_HUSBAND).build();
        ...
        index = INDEX_FIRST;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + SKILL_DESC_FRIEND;
        Person personToEdit = getModel().getFilteredPersonList().get(index.getZeroBased());
        editedPerson = new PersonBuilder(personToEdit).withSkills(VALID_SKILL_FRIEND).build();
        assertCommandSuccess(command, index, editedPerson);

        /* Case: clear tags -> cleared */
        index = INDEX_FIRST;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + " " + PREFIX_SKILL.getPrefix();
        editedPerson = new PersonBuilder(personToEdit).withSkills().build();
        assertCommandSuccess(command, index, editedPerson);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + CURRENT_POSITION_DESC_AMY + COMPANY_DESC_AMY + PROFILE_PICTURE_DESC_AMY
                + SKILL_DESC_FRIEND;
        ...
        /* Case: invalid current position -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST.getOneBased()
                + INVALID_CURRENT_POSITION_DESC, CurrentPosition.MESSAGE_CURRENT_POSITION_CONSTRAINTS);

        /* Case: invalid company -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST.getOneBased() + INVALID_COMPANY_DESC,
                Company.MESSAGE_COMPANY_CONSTRAINTS);

        /* Case: invalid skill -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST.getOneBased() + INVALID_SKILL_DESC,
