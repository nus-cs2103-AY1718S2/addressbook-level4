...
=== Saving Customers' Stats `[coming in v1.5rc]`
The statistics of customers will be stored in the hard disk.
...
=== Count the number of orders a customer has placed in the past `[coming in v2.0]`
