...
image::ReviewsCommandList.png[width="700"]

If you want to view book reviews for `Catching Fire`, enter `reviews 4`.

image::ReviewsCommandLoading.png[width="700"]

Bibliotek shows `Loading reviews of book: TITLE - Authors: AUTHORS` to indicate that your `reviews` is being processed.
Bibliotek is loading the reviews page of the book on https://goodreads.com[goodreads].

NOTE: The web page may take some time to load and will only be shown when ready.

image::ReviewsCommandLoaded.png[width="700"]

Once the web page is ready, Bibliotek shows `Reviews loaded successfully!` and displays the web page
at the right panel. Scroll down the web page to see the reviews for the book.

image::ReviewsCommandScrollDown.png[width="700"]
