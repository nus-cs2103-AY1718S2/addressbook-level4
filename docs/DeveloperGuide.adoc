...
The following diagram shows the student model including the primary attributes as well as the miscalleneous information attributes.
...
For the command `moreInfo`, the model manager 
