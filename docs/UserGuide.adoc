...
Displays the full information of a student on the browser panel. You will be able to view his/her profile picture too if one exists. +
...
2) Add, edit or delete a student using their coresponding commands to generate XML data of the students.


[large]*Steps Taken* +

. If you wish to view the profile page of the 1st student in the list, enter `moreInfo 1` in the command box.
