...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void editPerson() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  "
                + OPTION_OWNER + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
        ...
        command = EditCommand.COMMAND_WORD + OPTION_OWNER + " "
                + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NRIC_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        assertCommandSuccess(command, index, BOB);

        /* Case: edit some fields -> edited */
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + OPTION_OWNER + " "
                + index.getOneBased() + TAG_DESC_FRIEND;
        ...
        command = EditCommand.COMMAND_WORD + OPTION_OWNER + " " + index.getOneBased() + " " + NAME_DESC_BOB;
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + OPTION_OWNER + " 0" + NAME_DESC_BOB,
        ...
        command = EditCommand.COMMAND_WORD + OPTION_OWNER + " " + index.getOneBased()
