...
:repoURL: https://github.com/CS2103JAN2018-W10-B4/addressbook-level4/blob/master
...
|`* * *` |user |delete a tage from everyone in the address book |save time

|`* *` |user |export the contacts to a spreadsheet |furthre make use of them
...
[discrete]
== Use case: Delete old contacts

*MSS*

1.  User requests to delete old contacts.
2.  AddressBook prompts user for cut off date input.
3.  User enters cut off date.
4.  AddressBook prompts user for confirmation.
5.  User confirms deletion.
6.  AddressBook deletes all contact created before the cut off date.
7.  AddressBook shows success message.
+ 
Use case ends.
...
*Extensions*
[none]
* 3a.  If user input invalid date.
+
[none]
** 3a1.  AddressBook prompts user for cut off date input.
** 3a2.  User enters cut off date.
+
Steps 3a1 - 3a2 are repeated until date entered is correct.
+
Use case resumes from step 4.

* 5a.  If user decline the deletion.
+
Use case ends.

* 6a.  If there is no contact before the cut off date
** 6a1.  AddressBook shows error message
+
Use case ends.
