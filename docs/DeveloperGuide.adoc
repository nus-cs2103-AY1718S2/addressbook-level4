...
updated with the addition of the new appointment. Addition of entry to the `Calendar` object automatically reflects the change on the
...
===== Aspect: Data structure to support the appoinment commands
