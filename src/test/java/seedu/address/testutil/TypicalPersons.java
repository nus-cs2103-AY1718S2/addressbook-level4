...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY)
            ...
            .withDisplayPic(VALID_DISPLAY_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
            .withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB)
            .withMatriculationNumber(VALID_MATRIC_NUMBER_BOB).withPhone(VALID_PHONE_BOB)
            .withDisplayPic(VALID_DISPLAY_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
