...
|`* * *` |medical staff |filter the details that I want to see |easy access to information I need

|`* * *` |doctor |record health profile (chronic conditions and allergies) of the patient|

|`* * *` |medical staff |keep records of each visit of the patient |symptoms/condition of patient can be analysed and monitored
...
|`* *` |doctor |print out a formatted medical record |it can be easily show to the patient when explaining their condition
|=======================================================================
...
Precondition: User is logged in, the patient exists in the system
...
Preconditions: User is logged in, the patient is exist in the system
