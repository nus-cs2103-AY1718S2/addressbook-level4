...
image::colours.png[width="200"]

{empty} +
If you have already set up Medeina, head on to <<CLI>>. If you are already familiarize with Medeina's Command Line Interface (CLI), head on to <<Commands>>.
