...
public class JsonUserPrefsStorageTest {
    ...
    private UserPrefs getTypicalUserPrefs() {
        ...
        userPrefs.setGuiSettings(1000, 500, 300, 100, "/view/LightTheme.css");
        userPrefs.setAddressBookFilePath("medeina.xml");
        userPrefs.setAddressBookName("TypicalMedeina");
        return userPrefs;
    }
    ...
    public void saveUserPrefs_allInOrder_success() throws DataConversionException, IOException {
        ...
        original.setGuiSettings(1200, 200, 0, 2, "/view/LightTheme.css");
        ...
        original.setGuiSettings(5, 5, 5, 5, "/view/LightTheme.css");
        jsonUserPrefsStorage.saveUserPrefs(original);
