...
```
###### /java/seedu/flashy/ui/CardBack.java
``` java
/**
...
```
###### /java/seedu/flashy/ui/CardCard.java
``` java
/**
 * A UI component that displays information about a {@code Card}.
 */
...
```
###### /java/seedu/flashy/ui/CommandBox.java
``` java
    /**
...
```
###### /java/seedu/flashy/ui/MainWindow.java
``` java
    @Subscribe
...
```
###### /java/seedu/flashy/ui/CardListPanel.java
``` java
/**
...
```
###### /java/seedu/flashy/commons/events/ui/TagListPanelSelectionChangedEvent.java
``` java
/**
...
```
###### /java/seedu/flashy/commons/events/ui/CardListPanelSelectionChangedEvent.java
``` java
/**
...
```
###### /java/seedu/flashy/commons/events/ui/JumpToCardRequestEvent.java
``` java
/**
...
```
###### /java/seedu/flashy/commons/events/ui/ChangeThemeRequestEvent.java
``` java
/**
...
```
###### /java/seedu/flashy/commons/events/ui/EmptyCardBackEvent.java
``` java
/**
 * Represents a selection change in the Tag List Panel
 */
...
```
###### /java/seedu/flashy/logic/parser/SelectCardCommandParser.java
``` java
/**
...
```
###### /java/seedu/flashy/logic/parser/ChangeThemeCommandParser.java
``` java
/**
...
```
###### /java/seedu/flashy/logic/commands/ChangeThemeCommand.java
``` java
/**
...
```
###### /java/seedu/flashy/logic/commands/SelectCardCommand.java
``` java
/**
...
```
###### /java/seedu/flashy/logic/Autocompleter.java
``` java
/**
