...
*** Coming most of the user stories for the team's major enhancements.
** Enhancements to existing features:
*** Added 'esc' function feature whereby pressing 'esc' key allows deselection of list cell.
//*** Wrote additional tests for existing features to increase coverage from 88% to 92% (Pull requests https://github.com[#36], https://github.com[#38])
** Documentation:
*** Reviewed language and grammar for first half of the developer guide. Included pictures in the developer guide as well.
** Community:
*** Reviewing teammate's code before merging pull request.
*** Resolving merge conflicts as a result of a few consecutive pull request.
** Tools:
