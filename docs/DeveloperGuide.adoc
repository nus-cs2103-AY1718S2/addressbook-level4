...
The *_Architecture Diagram_* given below explains the high-level design of the App with 6 components.
...
* At shut down: It shuts down the components and invokes cleanup method where necessary.
