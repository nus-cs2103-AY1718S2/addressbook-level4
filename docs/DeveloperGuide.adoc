...
Fastis is a meet-up scheduler aimed at students in the National University of Singapore (NUS). It seeks to ease the process of scheduling meetings and discussions, especially between project teammates. Fastis provides functionality to quickly retrieve and process the schedules of different people/groups to help users plan for meet-ups. This guide documents important information for developers seeking to modify the application.
