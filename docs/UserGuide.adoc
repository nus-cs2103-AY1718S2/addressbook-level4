...
image::list1_screenshot.jpg[width="800"]
...
image::list2_screenshot.jpg[width="800"]
...
image::list3_screenshot.jpg[width="800"]
...
image::list4_screenshot.jpg[width="800"]
...
image::fav1_screenshot.jpg[width="800"]
...
image::fav2_screenshot.jpg[width="800"]
...
image::fav3_screenshot.jpg[width="800"]
...
image::unfav1_screenshot.jpg[width="800"]
...
image::unfav2_screenshot.jpg[width="800"]

[WARNING]
The student `INDEX` provided must be valid. Otherwise, an error message "The student index provided is invalid" will be displayed in the result box at *Step 3*.

.Error message displayed when an invalid student index is entered
image::unfav3_screenshot.jpg[width="800"]
...
Codeducator also allows you to create and add tasks to each milestone so that you can keep track of what has already been done and what still needs to be done to reach the milestone.
...
image::showDB1_screenshot.jpg[width="800"]
...
image::showDB2_screenshot.jpg[width="800"]

[WARNING]
The student `INDEX` provided must be valid. Otherwise, an error message "The student index provided is invalid" will be displayed in the result box at *Step 3*.

.Error message displayed when an invalid student index is entered
image::showDB3_screenshot.jpg[width="800"]
...
image::addMS1_screenshot.jpg[width="800"]
...
image::addMS2_screenshot.jpg[width="800"]
...
image::addMS3_screenshot.jpg[width="800"]
...
image::addMS4_screenshot.jpg[width="800"]
...
image::deleteMS1_screenshot.jpg[width="800"]
...
image::deleteMS2_screenshot.jpg[width="800"]
...
image::deleteMS3_screenshot.jpg[width="800"]
...
image::addTask1_screenshot.jpg[width="800"]
...
image::addTask2_screenshot.jpg[width="800"]

[WARNING]
The `STUDENT_INDEX` and `MILESTONE_INDEX` provided must be valid. Otherwise, an error message "One or more of the provided indexes are invalid" will be displayed in the result box at *Step 3*.

.Error message displayed when invalid `STUDENT_INDEX` and `MILESTONE_INDEX` are entered
image::addTask3_screenshot.jpg[width="800"]
...
image::deleteTask1_screenshot.jpg[width="800"]
...
image::deleteTask2_screenshot.jpg[width="800"]
...
image::deleteTask3_screenshot.jpg[width="800"]
...
image::checkTask1_screenshot.jpg[width="800"]
...
image::checkTask2_screenshot.jpg[width="800"]
...
image::checkTask4_screenshot.jpg[width="800"]

[WARNING]
The `STUDENT_INDEX`, `MILESTONE_INDEX`, and `TASK_INDEX` provided must be valid. Otherwise, an error message "One or more of the provided indexes are invalid" will be displayed in the result box at *Step 3*.

.Error message displayed when invalid `STUDENT_INDEX`, `MILESTONE_INDEX` and `TASK_INDEX` are entered
image::checkTask3_screenshot.jpg[width="800"]
