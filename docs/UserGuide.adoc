...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 cp/Software Engineer cc/Google pp//home/trafalgarandre/Desktop/John.jpg`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 cp/Student cc/NUS pp//home/trafalgarandre/Desktop/John.jpg t/criminal`
...
* `addjob p/Software Engineer t/Cloud Services l/Singapore n/2`
