...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_ORDER, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_HALAL, PREFIX_VEGETARIAN, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_PHONE, PREFIX_ORDER, PREFIX_EMAIL, PREFIX_ADDRESS)
        ...
        try {
            ...
            Person person = new Person(name, phone, order, email, address, halal, vegetarian, tagList);
