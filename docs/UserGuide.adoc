...
* White spaces after a colon are automatically trimmed. For example, `add Recipe Name: Chicken rice` and `add Recipe Name:Chicken rice` are the same. However, the former is more visually pleasing.
* Press kbd:[Enter] while holding down kbd:[Shift] to add a new line to your input.
