...
=== Lock the AddressBook: `lock` `[Since v1.2]`
...
=== Sort the employees by any existing field: `sort` `[Since v1.2]`
...
=== Unlock the AddressBook: `unlock` `[Since v1.2]`
...
=== Add event on one employee's timetable: `addEvent` `[Since v1.2]`
...
=== Search employee by rating `[coming in v2.0]`

=== edit a timetable entry `[coming in v2.0]`

=== delete a timetable entry `[coming in v2.0]`

=== Login `[coming in v2.0]`

=== Mass adding timetable entry to many employees' timetable at once `[coming in v2.0]`

=== have my own timetable `[coming in v2.0]`

=== start composing an email with a command `[coming in v2.0]`

=== view to-do-list `[coming in v2.0]`

=== change the window scheme/theme/skin `[coming in v2.0]`

// tag::dataencryption[]
=== Encrypting data files `[coming in v2.0]`

=== Export the data `[coming in v1.4]`
...
=== Import the data `[coming in v1.4]`
