...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 b/09-12-1994 i/Health[100] g/family`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 b/29-10-1992 g/friends i/General t/criminal`
...
* As of v1.4, the application handles the command for the portfolio and calendar.
...
Set a password for reInsurance as desired. No password required to access the program. +
Format: `password` Alias: `pw`
