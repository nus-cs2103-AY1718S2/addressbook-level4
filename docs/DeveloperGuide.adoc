...
* prefers being on desktop rather than on mobile
* generally comfortable with typing on CLI applications without clicking
* is a veterinarian or assistant from a vet clinic in Singapore
* has to manage a significant number of <<patients,patients>>
...
[[patients]] Patients::
Domestic animals that visit the vet clinic with their owners
