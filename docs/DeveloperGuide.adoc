...
* keep track of your teammates' completion of TO-DO list and learning progress (providing proof for peer evaluation)
...
* save your answers for the exercises (as proof of completion and for future revision)
...
|`* * *` |new user |fill in my full name and phone number |provide necessary information for the platform maintenance
