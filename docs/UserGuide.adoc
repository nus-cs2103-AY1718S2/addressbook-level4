...
=== Locating persons taking that module: `module`
...
=== Viewing common time slots in timetable: `free`

Displays the common free time of two people in the addressbook. +
Format: `free [PERSON1] [PERSON2]`
