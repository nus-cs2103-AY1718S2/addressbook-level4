...
Welcome to contactHeRo developer guide. This guide aims to contain all the information required to quickly get you to start developing contactHeRo. +
...
1. Kushagra Goyal
 * Major Feature: Reminders
 ** Users can add reminders with subject, date and time.
 ** Users can delete reminders.
 ** The reminders will be displayed on the screen sorted according to earliest time due.
 ...
 ** Major Feature: Recruiters have a lot of appointments, meetings, and interviews to manage and these reminders will help them keep a track of these events so that they do not miss them, be late for any of them and they can better manage their time.
 ** Minor Feature: Viewing the contact details in a separate focused panel makes them easier to read for the user and the information looks clearer. Moreover, recruiters need to keep a track of the professional progress of his/her potential recruits and having easy access to their LinkedIn profiles will help them do this efficiently.
...
.  The address book should be able to export to other computers.
