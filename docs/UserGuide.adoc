...
****
* FILENAME must not start with / or \ or have consecutie slashes.
* FILENAME will be concatenated with .xml to maintain formatting.
* If FILENAME already exists in the user's Dropbox, one of two things will happen:
** File will not be uploaded if contents of the two files are similar.
** File will be uploaded and renamed to FILENAME(1..) if contents of the two files are different.
****
