...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthCoinIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthCoinIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthCoinIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthCoinIndex.equals(fifthCoinIndex));

        // null -> returns false
        assertFalse(fifthCoinIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthCoinIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthCoinIndex.equals(Index.fromOneBased(1)));
    }
}
