...
2.  AddressBook prompts user to input a location
3.  User requests venues near this specific location
4.  AddressBook prints out a list of available locations near the specified location
+
Use case ends.
...
+
[none]
** 3a1. AddressBook displays the empty result
+
Use case resumes at step 2
