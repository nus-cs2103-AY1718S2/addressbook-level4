...
|`* * *` |user |list out patients of a specific species and their owners' contact information |contact them for blood donation

|`* * *` |user |log in with passwords |protect my patients' and their respective owners' information
...
|`* *` |user |check who is my assistant for the day/particular patient |brief them in advance
...
|`* *` |user |manage the "rooms" in hospital |make space for newly hospitalized patient
