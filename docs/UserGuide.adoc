...
****
* Selects the person and loads the distance from the headquarter to the person address `INDEX`.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* `1, 2, 3, ...`
****
...
* `list` +
`distance 2` +
Return the distance from the headquarter to the 2nd person in the address book.
* `find Betsy` +
`distance 1` +
Return the distance from the headquarter to the 1st person in the address book.
