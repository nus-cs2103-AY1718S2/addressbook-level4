...
public class XmlAdaptedAppointmentTest {
    ...
    private static final Person VALID_OWNER = ALLY.getOwner();
    private static final PetPatient VALID_PET = ALLY.getPetPatient();
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedAppointment appointment =
                new XmlAdaptedAppointment(null, VALID_REMARK, VALID_PET, VALID_DATETIME, VALID_TYPE);
