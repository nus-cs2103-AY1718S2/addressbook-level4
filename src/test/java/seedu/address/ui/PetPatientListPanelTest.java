...
//import static seedu.address.testutil.TypicalPetPatients;
...
//    @Before
//    public void setUp() {
//        PetPatientListPanel patientListPanel = new PetPatientListPanel(TYPICAL_PETPATIENTS);
//        uiPartRule.setUiPart(petPatientListPanel);
//
//        petPatientListPanelHandle = new PetPatientListPanelHandle(getChildNode(patientListPanel.getRoot(),
