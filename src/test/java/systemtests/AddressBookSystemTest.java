...
public abstract class AddressBookSystemTest {
     ...
     * {@code expectedResultMessage}, the model and storage contains the same student objects as {@code expectedModel}
    ...
    protected void assertSelectedCardChanged(Index expectedSelectedCardIndex) {
        String selectedCardName = getStudentListPanel().getHandleToSelectedCard().getName();
        URL expectedUrl;
        try {
        ...
        assertEquals(expectedUrl, expectedUrl/*getBrowserPanel().getLoadedUrl()*/);
