...
```
###### \java\seedu\address\logic\commands\AddMemberToGroupCommandTest.java
``` java
package seedu.address.logic.commands;
...
```
###### \java\seedu\address\logic\commands\DeleteMemberFromGroupCommandTest.java
``` java
package seedu.address.logic.commands;
...
```
###### \java\seedu\address\logic\parser\AddMemberToGroupCommandParserTest.java
``` java
package seedu.address.logic.parser;
...
```
###### \java\seedu\address\logic\parser\DeleteMemberFromGroupCommandParserTest.java
``` java
package seedu.address.logic.parser;
...
```
###### \java\seedu\address\model\group\DuplicateGroupTest.java
``` java
...
```
###### \java\seedu\address\model\group\MembersInGroupPredicateTest.java
``` java
package seedu.address.model.group;
