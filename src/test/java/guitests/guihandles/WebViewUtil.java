...
public class WebViewUtil {
    ...
    /**
     * If the {@code detailPanelHandle}'s {@code WebView} is loading, sleeps the thread till it is successfully loaded.
     */
    public static void waitUntilBrowserLoaded(DetailPanelHandle detailPanelHandle) {
        new GuiRobot().waitForEvent(detailPanelHandle::isLoaded);
    }
}
