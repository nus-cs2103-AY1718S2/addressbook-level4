...
Tasks displayed in a date cell are sorted by their priority. Tasks are displayed in `Todo List` and `Calender` as shown in figure 19.

.Tasks displayed in the application.
//update image
image::displayTask.png[width = "600"]
