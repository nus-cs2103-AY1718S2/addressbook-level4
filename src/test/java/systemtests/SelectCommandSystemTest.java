...
public class SelectCommandSystemTest extends RecipeBookSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered person list, select index within bounds of recipe book but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of recipe book and person list -> selected */
