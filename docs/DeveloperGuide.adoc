...
Major: Implementation of model and related components to support new subclasses, ensure basic functions work with the new model, and to enable new target user-specific functions, such as assigning customers to a runner.
...
Major: Implement new UI option for displaying relevant information of selected persons.
