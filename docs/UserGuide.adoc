...
****
* Adds a milestone to a dashboard of a student at the specified `STUDENT_INDEX`.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
...
****
* Adds a task to a milestone at the specified `MILESTONE_INDEX`
...
****
* Marks a task at the specified `TASK_INDEX` as completed
* The task is in a milestone at the specified `MILESTONE_INDEX`
* The milestone is in the dashboard of a student at the specified `STUDENT_INDEX`
