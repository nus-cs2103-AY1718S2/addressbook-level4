...
public class StatusBarFooter extends UiPart<Region> {
    ...
    @Subscribe
    public void handleBookShelfChangedEvent(BookShelfChangedEvent bsce) {
        long now = clock.millis();
        String lastUpdated = new Date(now).toString();
        logger.info(LogsCenter.getEventHandlingLogMessage(bsce, "Setting last updated status to " + lastUpdated));
