...
**** Can be easily shown to patients when explaining about their condition

* *Kai Yong*:
** Major Features:
*** Maintain a waiting list of patients (Visiting queue)
**** Medical staff and doctor can easy access basic information and medical profile of next patient in the queue.
** Minor Features:
