...
public class CommandBox extends UiPart<Region> {
    ...
    private static final String[] allCommandsWord = {AddCommand.COMMAND_WORD, EditCommand.COMMAND_WORD,
        ...
        NotiCommand.COMMAND_WORD, DeleteEventCommand.COMMAND_WORD, AddPhotoCommand.COMMAND_WORD,
        ExportEmployeesCommand.COMMAND_WORD, AuthenCommand.COMMAND_WORD};
    private static final String[] allCommandsUsage = {AddCommand.MESSAGE_USAGE, EditCommand.MESSAGE_USAGE,
        ...
        ClearCommand.MESSAGE_USAGE, NotiCommand.MESSAGE_USAGE, DeleteEventCommand.MESSAGE_USAGE,
        AddPhotoCommand.MESSAGE_USAGE, ExportEmployeesCommand.MESSAGE_USAGE, AuthenCommand.COMMAND_USAGE};
