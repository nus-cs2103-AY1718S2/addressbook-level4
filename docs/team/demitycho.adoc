...
|===
|_Given below are sections I contributed to the User Guide. They showcase my ability to write documentation targeting end-users. I wrote extensive parts in my user and developer guides, but excluded them to fit within the page limit.
|===
