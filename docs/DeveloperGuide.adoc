...
* Down to the left, is the list of people in the address book. As seen in Figure 8 below.
...
** The individual person cards implements the link:{repoURL}/src/main/java/seedu/address/ui/PersonCard.java[`PersonCard`] class whose layout is specified in link:{repoURL}/src/main/resources/view/PersonCard.fxml[`PersonCard.fxml`].

.Person list of the UI
image::PersonList.png[width="350"]

* To the right, is the calendar of the address book, in V2.0 task can be scheduled into this calendar. As seen in Figure 9 below.
