...
public class XmlAdaptedTaskTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedTask person =
                new XmlAdaptedTask(INVALID_NAME, VALID_PRIORITY, VALID_DEADLINE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedTask person = new XmlAdaptedTask(null, VALID_PRIORITY, VALID_DEADLINE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidPriority_throwsIllegalValueException() {
        XmlAdaptedTask person =
                new XmlAdaptedTask(VALID_NAME, INVALID_PRIORITY, VALID_DEADLINE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPriority_throwsIllegalValueException() {
        XmlAdaptedTask person = new XmlAdaptedTask(VALID_NAME, null, VALID_DEADLINE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidDeadline_throwsIllegalValueException() {
        XmlAdaptedTask person =
                new XmlAdaptedTask(VALID_NAME, VALID_PRIORITY, INVALID_DEADLINE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        XmlAdaptedTask person =
                new XmlAdaptedTask(VALID_NAME, VALID_PRIORITY, VALID_DEADLINE, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedTask person =
                new XmlAdaptedTask(VALID_NAME, VALID_PRIORITY, VALID_DEADLINE, VALID_ADDRESS, invalidTags);
