...
This guide provides information on the core functionalities of CLIndar and its implementation, so that you can
...
To fork the repo, click the button circled below in _Figure 1_:
...
.Relevant Components interactions for `rm task 1` command (part 1)
...
.Relevant Components interactions for `rm task 1` command (part 2)
