 ...
 */
public class HelpCommandSystemTest extends CoinBookSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_COIN.getOneBased());
        ...
        executeCommand(DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_COIN.getOneBased());
