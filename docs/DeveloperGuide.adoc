...
|Wayne Neo| Designing UI for Timetable. UI will display the timetable of each person and also the union of timetables to find common timeslots| Adding of Birthday class into the `Person` class. This allows users to generate a list of birthdays to celebrate with their friends.
|=======================================================================
