...
Format: `calendar-add en/<eventname> std/<startdatetime> etd/<enddatetime> loc/<location> lp/<linkedperson>(optional)`
...
Application will request for your login credentials (username and password) before allowing you to access it.

=== Logout from your account: `logout`

Application allows to log out from your account so that you can ensure confidentiality of your data.
