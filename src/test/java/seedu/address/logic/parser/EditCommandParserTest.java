...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone followed by valid order
        assertParseFailure(parser, "1" + INVALID_PHONE_DESC + ORDER_DESC_AMY, Phone.MESSAGE_PHONE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_ORDER_DESC + VALID_ADDRESS_AMY + VALID_PHONE_AMY,
