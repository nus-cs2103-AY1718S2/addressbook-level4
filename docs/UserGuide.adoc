...
=== Sorting the list of students based on overall rating score : `rating-sort` `[since v1.3]`

Sorts the current list of students in HR+ based on overall rating score in descending or ascending order. +
Format: `rating-sort o/SORT ORDER`
...
* *Sort by Rating* : `rating-sort o/SORT ORDER` +
e.g. `rating-sort o/asc`
