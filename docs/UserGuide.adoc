...
* `add n/Betsy Crowe t/friend a/Newgate Prison p/1234567 t/criminal f/Chicken chop h/HALAL`
* `a n/John Doe p/98765432  a/John street, block 123, #01-01 f/Chicken rice h/HALAL v/VEGETARIAN`
* `a n/Betsy Crowe t/friend a/Newgate Prison p/1234567 t/criminal f/Chicken chop h/HALAL`
