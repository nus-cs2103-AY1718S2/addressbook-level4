...
+
* For Windows:
** kbd:[Ctrl] + kbd:[Shift] + kbd:[&rarr;] : Navigates timetable to the next week.
** kbd:[Ctrl] + kbd:[Shift] + kbd:[&larr;] : Navigates timetable to the previous week.
** kbd:[Ctrl] + kbd:[Shift] + kbd:[&darr;] : Navigates timetable to the current week.
* For Mac:
** kbd:[Command] + kbd:[Shift] + kbd:[&rarr;] : Navigates timetable to the next week.
** kbd:[Command] + kbd:[Shift] + kbd:[&larr;] : Navigates timetable to the previous week.
** kbd:[Command] + kbd:[Shift] + kbd:[&darr;] : Navigates timetable to the current week.
. Using Mouse Clicks
+
...
.PTMan Admin Password Change Command  +
...
.Successful PTMan Admin Password Change +
...
.PTMan Admin Password Reset Command +
...
.Successful PTMan Admin Password Reset +
...
+
[[fig-addingSalary]]
.PTMan Add Employee Salary Command +
...
+
[[fig-Ui_edit1]]
.PTMan Edit Employee Details Command  +
...
+
[[fig-Ui_delete3]]
.Successful Deletion of Employee in PTMan +
...
+
[[fig-Edit1]]
.PTMan Edit Outlet Information Command +
...
+
[[fig-Edit3]]
.PTMan Edit Selective Outlet Information Command +
...
+
[[fig-addshiftAfter]]
.Successful Adding of a Shift in PTMan +
...
.Successful Deletion of Shift 1 in PTMan +
...
.PTMan Apply Employee 2 to Shift 3 Command +
...
+
[[fig-applyAdminAfter]]
.Successful Application of Employee 2 to Shift 3 in PTMan +
...
.PTMan Remove Employee 2 from Shift 3 Command +
...
.Successful Removal of Employee 2 from Shift 3 in PTMan +
...
*Shorthand:* `ap EMPLOYEE_INDEX SHIFT_INDEX pw/PASSWORD`
****
* The `EMPLOYEE_INDEX` refers to the index number shown in the most recent employee listing.
* The `SHIFT_INDEX` refers to the shift number in the timetable.
* Both indexes *must be positive integers* 1, 2, 3, ...
...
+
[[fig-changingpw]]
.PTMan Change Employee Password Command +
