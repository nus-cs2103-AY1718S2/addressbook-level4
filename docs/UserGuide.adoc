...
List members of group CS2101 Oral Presentation seen in Figure 8.
image:listGroupMembersExample.png[width = "800"] +
Figure 8. Example of ListGroupMembers. +
[NOTE]
====
...
Deletes group `CS3243`  refer to Figure 9. +
image:dGExample.png[width ="800"] +
Figure 9. Example of deleteGroup +
[NOTE]
====
