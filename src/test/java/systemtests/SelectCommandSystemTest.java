...
import static seedu.progresschecker.logic.commands.SelectCommand.MESSAGE_SELECT_PERSON_SUCCESS;
...
import static seedu.progresschecker.testutil.TypicalPersons.getTypicalPersons;
...
public class SelectCommandSystemTest extends ProgressCheckerSystemTest {
    @Test
    public void select() {
        ...
        String commandMixedCase = "SeLECt" + " " + middleIndex.getOneBased();
        ...
        assertCommandSuccess(commandMixedCase, middleIndex);

        /* ------------------------ Perform select operations on the shown filtered list ---------------------------- */

        /* Case: filtered person list, select index within bounds of ProgressChecker but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of ProgressChecker and person list -> selected */
        ...
        /* Case: select from empty ProgressChecker -> rejected */
        deleteAllPersons();
