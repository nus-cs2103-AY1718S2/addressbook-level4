...
|`* * *` |tutor |indicate a student's subject when adding one |
...
|`* * *` |user |find a student by subject |locate details of students of a certain subject
...
|`* *` |tutor |sort the contact list by subject | easily recognise which and how many students are taking a particular subject
...
|`* * *` |user |add a subject for a student |

|`* * *` |user |get an overview of my student's progress |so that I can tutor them better

|`* * *` |user |add a subject for a student |

|`* * *` |user |type little but get the command I want |to save time

|`*` |user |send emails to my student |
