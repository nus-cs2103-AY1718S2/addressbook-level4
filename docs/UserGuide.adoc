...
* After typing partial command, press TAB for the command to be auto-completed. For e.g typing 'a' and pressing TAB will give the entire syntax for 'add' command.
