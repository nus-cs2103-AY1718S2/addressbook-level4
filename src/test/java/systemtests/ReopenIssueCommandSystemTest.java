...
public class ReopenIssueCommandSystemTest extends ProgressCheckerSystemTest {
    ...
    public void reopenIssue() throws Exception {
        ...
        String command = "     " + ReopenIssueCommand.COMMAND_WORD + "      "
                + INDEX_ISSUE_ONE.getOneBased() + "       ";
        String expectedResultMessage = String.format(ReopenIssueCommand.MESSAGE_SUCCESS,
        ...
        command = ReopenIssueCommand.COMMAND_WORD + " 34";
        assertCommandFailureWithoutAuthentication(command, ReopenIssueCommand.MESSAGE_AUTHENTICATION_FAILURE);

        /* Case: invalid index (0) -> rejected */
        command = ReopenIssueCommand.COMMAND_WORD + " 0";
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, ReopenIssueCommand.MESSAGE_USAGE));

        /* Case: invalid index (-1) -> rejected */
        command = ReopenIssueCommand.COMMAND_WORD + " -1";
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, ReopenIssueCommand.MESSAGE_USAGE));

        /* Case: invalid index -> rejected */
        command = ReopenIssueCommand.COMMAND_WORD + " " + 99999;
        assertCommandFailure(command, ReopenIssueCommand.MESSAGE_FAILURE);

        /* Case: invalid arguments (alphabets) -> rejected */
        assertCommandFailure(ReopenIssueCommand.COMMAND_WORD + " abc",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, ReopenIssueCommand.MESSAGE_USAGE));

        /* Case: invalid arguments (extra argument) -> rejected */
        assertCommandFailure(ReopenIssueCommand.COMMAND_WORD + " 1 abc",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, ReopenIssueCommand.MESSAGE_USAGE));
     ...
     * @see ReopenIssueCommandSystemTest#assertCommandSuccess(String, Model, String)
