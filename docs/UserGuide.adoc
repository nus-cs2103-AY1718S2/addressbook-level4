...
* *<<registering-new-account, Signup>>* : `signup u/USERNAME pw/PASSWORD` +
e.g. `signup u/JohnDoe pw/doe123` +
* *<<logging-in, Login>>* : `login u/USERNAME pw/PASSWORD` +
e.g. `login u/JohnDoe pw/doe123` +
