...
import static seedu.address.logic.commands.CommandTestUtil.VALID_DATE_ADDED_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withDateAdded(createDate())
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withDateAdded(createDate())
                .withTags().build();
