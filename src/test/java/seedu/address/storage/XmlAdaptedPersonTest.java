...
public class XmlAdaptedPersonTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(null, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_EXPECTED_GRADUATION_YEAR, VALID_RESUME, VALID_INTERVIEW_DATE, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null,  VALID_EXPECTED_GRADUATION_YEAR, VALID_RESUME, VALID_INTERVIEW_DATE, VALID_TAGS);
    ...
    public void toModelType_invalidExpectedGraduationYear_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_EXPECTED_GRADUATION_YEAR, VALID_RESUME, VALID_INTERVIEW_DATE, VALID_TAGS);
    ...
    public void toModelType_nullExpectedGraduationYear_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS,  null, VALID_RESUME, VALID_INTERVIEW_DATE, VALID_TAGS);
    ...
    public void toModelType_invalidResume_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_EXPECTED_GRADUATION_YEAR, INVALID_RESUME, VALID_INTERVIEW_DATE, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_EXPECTED_GRADUATION_YEAR, VALID_RESUME, VALID_INTERVIEW_DATE, invalidTags);
