...
==== Adding a condition to an existing patient: `addc` [coming in v1.3]
...
==== Viewing certain details only: `filter` [coming in v1.3]
...
The commands listed in this section are commands that do not pertain to the queue.
...
* *View Appointment* : `viewappt` or `va`
