...
|`* * *` |student with design background |view tasks only|as I prefer have less clutter in the GUI

|`* * *` |student with design background |view events only|as I prefer have less clutter in the GUI
