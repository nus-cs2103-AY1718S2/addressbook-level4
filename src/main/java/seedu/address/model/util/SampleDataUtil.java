    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new ExpectedGraduationYear("2019"), new Major("Computer Science"),
                new Rating(-1, -1,
                        -1, -1),
                new Resume(null), new InterviewDate(), getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new ExpectedGraduationYear("2020"), new Major("Computer Science"),
                new Rating(4.5, 3,
                        4.5, 2.5),
                new Resume(formPathFromFileName("char.pdf")), new InterviewDate(), getTagSet("neighbours")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new ExpectedGraduationYear("2020"), new Major("Computer Science"),
                new Rating(-1, -1,
                        -1, -1),
                new Resume(null), new InterviewDate(), getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new ExpectedGraduationYear("2021"), new Major("Computer Science"),
                new Rating(3, 5, 3.5, 3),
                new Resume(null), new InterviewDate(), getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), new ExpectedGraduationYear("2019"), new Major("Computer Science"),
                new Rating(-1, -1,
                        -1, -1),
