...
import static seedu.flashy.logic.commands.CommandTestUtil.INVALID_0DAY_OF_MONTH;
import static seedu.flashy.logic.commands.CommandTestUtil.INVALID_29FEBRUARY;
import static seedu.flashy.logic.commands.CommandTestUtil.INVALID_30FEBRUARY;
import static seedu.flashy.logic.commands.CommandTestUtil.INVALID_31APRIL;
import static seedu.flashy.logic.commands.CommandTestUtil.INVALID_32DAY_OF_MONTH;
import static seedu.flashy.logic.commands.CommandTestUtil.INVALID_32MARCH;
import static seedu.flashy.logic.commands.CommandTestUtil.LIST_DAY_MONTH_YEAR;
import static seedu.flashy.logic.commands.CommandTestUtil.LIST_PREFIX_RUBBISH;
import static seedu.flashy.logic.commands.CommandTestUtil.LIST_VALID_DAY_MONTH_YEAR;
...
import static seedu.flashy.logic.parser.ParserUtil.MESSAGE_INVALID_NUMBER;
import static seedu.flashy.model.card.Schedule.MESSAGE_DAY_CONSTRAINTS;
import static seedu.flashy.testutil.DateStringPermutationBuilder.preparePowerSetDateTime;
import static seedu.flashy.testutil.DateStringPermutationBuilder.preparePowerSetString;
