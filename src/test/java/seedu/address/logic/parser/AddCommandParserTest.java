...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TIMETABLE_LINK_DESC_BOB + DETAIL_DESC_BOB + TAG_DESC_FRIEND,
        ...
        Person expectedPersonMultipleTags = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTimeTableLink(VALID_TIMETABLE_LINK_BOB)
                .withDetail(VALID_DETAIL_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).build();
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid detail
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TIMETABLE_LINK_DESC_BOB + INVALID_DETAIL_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Detail.MESSAGE_DETAIL_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TIMETABLE_LINK_DESC_BOB + DETAIL_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
