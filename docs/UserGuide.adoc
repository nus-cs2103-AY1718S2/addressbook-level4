...
[[Features]]
== Features
As contactHeRo is a *Command Line Interface(CLI) application*, you need to type in commands in order to use contactHeRo features.

Below is the interface of contactHeRo for you to type your command. +

image::command.png[width="790"]
Whenever you type in a command. It will show you the right format of the command. +

====

The command = name of command + parameters

====
To understand how to fill in the parameter, let's us show you the command format for the parameters.
====
...
Now as you have understood the command format, let's explore the features:
...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [pp/PROFILE_PICTURE_PATH] [t/TAG]...`
...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 pp//home/trafalgarandre/Desktop/John.jpg`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 pp//home/trafalgarandre/Desktop/John.jpg t/criminal`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [pp/PROFILE_PICTURE_PATH][t/TAG]...`
...
You can arrange meeting on Gmail calender using contactHero.

=== Setting reminders `[coming in v1.5]`
...
*A*: Please send an email to contactHeRo@gmail.com if you find bug. Thank you.
