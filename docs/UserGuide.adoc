...
You can unlock the APP while it is locked if you wish to do modification on contact and appointment. The initial password is 123456. Please remember that after unlocking, the content won automatically show. Please use list/listall/listappointment command. +
