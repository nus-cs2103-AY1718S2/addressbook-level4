...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + PHONE_DESC_AMY + " "
                ...
                + MAJOR_DESC_AMY + " " + GRADE_POINT_AVERAGE_DESC_AMY + " " + RESUME_DESC_AMY + TAG_DESC_FRIEND + " ";
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                ...
                + GRADE_POINT_AVERAGE_DESC_AMY + RESUME_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + EXPECTED_GRADUATION_YEAR_DESC_BOB + MAJOR_DESC_AMY
                + GRADE_POINT_AVERAGE_DESC_AMY + RESUME_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                ...
                .withResume(VALID_RESUME_AMY).withTags(VALID_TAG_FRIEND).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + EXPECTED_GRADUATION_YEAR_DESC_AMY + MAJOR_DESC_BOB
                + GRADE_POINT_AVERAGE_DESC_AMY + RESUME_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + EXPECTED_GRADUATION_YEAR_DESC_AMY + MAJOR_DESC_AMY
                + GRADE_POINT_AVERAGE_DESC_BOB + RESUME_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + EXPECTED_GRADUATION_YEAR_DESC_AMY + GRADE_POINT_AVERAGE_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + INVALID_EXPECTED_GRADUATION_YEAR_DESC + MAJOR_DESC_AMY + GRADE_POINT_AVERAGE_DESC_AMY;
