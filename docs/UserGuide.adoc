...
Test input: +
    1. Person1 with income 20k, spending 1k. +
    2. Person2 with income 40k, spending 2k. +
    3. Person  with income 10k, no spending specified +

    ==>  predict =>> Person3 now shows expected spending of 500

Test Input 2: +
    1. Person1 with income 1234568k, spending 10 +
    2. Person2 with income 20k, spending 1k +
...
* `add_policy 3 beg/01/02/2018 exp/31/02/2018 pr/140 is/car_damage is/theft`
