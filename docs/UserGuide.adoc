...
Keyboard shortcut (to populate prefixes): `Alt` + `A`
...
Keyboard shortcut (to populate prefixes): `Alt` + `E`
...
Keyboard shortcut (to populate prefix): `Ctrl` + `F`
...
Alias: `d` +
Format: `delete INDEX` +
Keyboard shortcut (to populate prefix): `Alt` + `D`
...
Alias: `s` +
Format: `select INDEX` +
Keyboard shortcut (to populate prefix): `Alt` + `S`
