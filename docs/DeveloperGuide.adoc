...
*** Implementing `add appointment` command to support the creation of new appointments by the user.
...
|`* * *` |user |store appointment dates and details |keep track of them
...
|`* *` |user |export the contacts to a spreadsheet |further make use of them
...
|`* *` |user |import contacts from xls and doc files |speed up the process of adding new contacts
