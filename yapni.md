# yapni
###### \build\resources\main\view\DashboardPanel.fxml
``` fxml
...
```
###### \build\resources\main\view\InfoPanel.fxml
``` fxml
...
```
###### \build\resources\main\view\MilestoneCard.fxml
``` fxml
...
```
###### \build\resources\main\view\TaskCard.fxml
``` fxml
...
```
###### \out\production\classes\view\DashboardPanel.fxml
``` fxml
...
```
###### \out\production\classes\view\InfoPanel.fxml
``` fxml
<?import javafx.scene.layout.StackPane?>
...
```
###### \out\production\classes\view\MilestoneCard.fxml
``` fxml
...
```
###### \out\production\classes\view\TaskCard.fxml
``` fxml
...
```
###### \src\main\java\seedu\address\commons\events\ui\ShowMilestonesEvent.java
``` java
/**
...
```
###### \src\main\java\seedu\address\commons\events\ui\ShowStudentDashboardEvent.java
``` java
/**
...
```
###### \src\main\java\seedu\address\commons\events\ui\ShowStudentNameInDashboardEvent.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\AddMilestoneCommand.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\CheckTaskCommand.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\DashboardBuilder.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\DeleteMilestoneCommand.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\MilestoneBuilder.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\ProgressBuilder.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\ShowDashboardCommand.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\commands\TaskBuilder.java
``` java
/**
 * A utility class to help with building Milestone objects.
 */
...
```
###### \src\main\java\seedu\address\logic\commands\util\CheckIndexesUtil.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\parser\AddMilestoneCommandParser.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\parser\CheckTaskCommandParser.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\parser\DeleteMilestoneCommandParser.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\parser\ShowDashboardCommandParser.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\Dashboard.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\Date.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\exceptions\DuplicateMilestoneException.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\exceptions\DuplicateTaskException.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\exceptions\MilestoneNotFoundException.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\exceptions\TaskNotFoundException.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\Milestone.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\Progress.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\Task.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\UniqueMilestoneList.java
``` java
/**
...
```
###### \src\main\java\seedu\address\model\student\dashboard\UniqueTaskList.java
``` java
/**
...
```
###### \src\main\java\seedu\address\storage\XmlAdaptedDashboard.java
``` java
/**
...
```
###### \src\main\java\seedu\address\storage\XmlAdaptedMilestone.java
``` java
/**
...
```
###### \src\main\java\seedu\address\ui\DashboardPanel.java
``` java
/**
...
```
###### \src\main\java\seedu\address\ui\InfoPanel.java
``` java
/**
...
```
###### \src\main\java\seedu\address\ui\MilestoneCard.java
``` java
/**
...
```
###### \src\main\resources\view\DashboardPanel.fxml
``` fxml
...
```
###### \src\main\resources\view\InfoPanel.fxml
``` fxml
<?import javafx.scene.layout.StackPane?>
...
```
###### \src\main\resources\view\MilestoneCard.fxml
``` fxml
...
```
###### \src\main\resources\view\TaskCard.fxml
``` fxml
...
```
###### \src\test\java\seedu\address\logic\commands\AddMilestoneCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\logic\commands\AddTaskCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\logic\commands\CheckTaskCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\logic\commands\DeleteMilestoneCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\logic\commands\DeleteTaskCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\logic\commands\FavouriteCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\logic\commands\UnfavouriteCommandTest.java
``` java
/**
...
```
###### \src\test\java\seedu\address\model\student\dashboard\DateTest.java
``` java
...
```
###### \src\test\java\seedu\address\model\student\dashboard\ProgressTest.java
``` java
...
```
###### \src\test\java\seedu\address\model\student\dashboard\UniqueMilestoneListTest.java
``` java
...
```
###### \src\test\java\seedu\address\model\student\dashboard\UniqueTaskListTest.java
``` java
...
```
###### \src\test\java\seedu\address\testutil\MilestoneBuilder.java
``` java
/**
 * A utility class to help with building Milestone objects.
 */
...
```
###### \src\test\java\seedu\address\testutil\ProgressBuilder.java
``` java
/**
 * A utility class to help with building Progress objects.
 */
...
```
###### \src\test\java\seedu\address\testutil\TypicalMilestones.java
``` java
/**
...
```
###### \src\test\java\seedu\address\testutil\TypicalTasks.java
``` java
/**
