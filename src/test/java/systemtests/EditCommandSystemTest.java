...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_AMY + "  "
                + PHONE_DESC_AMY + " " + EMAIL_DESC_AMY + "  " + ADDRESS_DESC_AMY + " " + UNIVERSITY_DESC_AMY + " "
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + UNIVERSITY_DESC_AMY + EXPECTED_GRADUATION_YEAR_DESC_AMY
                + MAJOR_DESC_AMY + GRADE_POINT_AVERAGE_DESC_AMY + JOB_APPLIED_DESC_AMY + RESUME_DESC_AMY
        ...
        /* Case: clear resume -> cleared */
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + " " + PREFIX_RESUME.getPrefix();
        editedPerson = new PersonBuilder(personToEdit).withResume(null).build();
        assertCommandSuccess(command, index, editedPerson);

        /* Case: clear profile image -> cleared */
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + " " + PREFIX_IMAGE.getPrefix();
        editedPerson = new PersonBuilder(personToEdit).withResume(null).withProfileImage(null).build();
        assertCommandSuccess(command, index, editedPerson);
        ...
        editedPerson = new PersonBuilder(personToEdit)
                .withResume(null).withProfileImage(null).withComment(null).build();
        assertCommandSuccess(command, index, editedPerson);
        ...
        editedPerson = new PersonBuilder(personToEdit)
                .withResume(null).withProfileImage(null).withComment(null).withTags().build();
        assertCommandSuccess(command, index, editedPerson);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + UNIVERSITY_DESC_AMY + EXPECTED_GRADUATION_YEAR_DESC_AMY + MAJOR_DESC_AMY
                + GRADE_POINT_AVERAGE_DESC_AMY + JOB_APPLIED_DESC_AMY
                + RESUME_DESC_AMY + PROFILE_IMAGE_DESC_AMY + COMMENT_DESC_AMY + TAG_DESC_FRIEND;
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased()
                + INVALID_UNIVERSITY_DESC, University.MESSAGE_UNIVERSITY_CONSTRAINTS);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + GRADE_POINT_AVERAGE_DESC_BOB + JOB_APPLIED_DESC_BOB + RESUME_DESC_BOB + PROFILE_IMAGE_DESC_BOB
                + COMMENT_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
