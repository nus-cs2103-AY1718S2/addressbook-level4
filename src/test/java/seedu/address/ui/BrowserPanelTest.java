...
public class BrowserPanelTest extends GuiUnitTest {
    private ActivityPanelSelectionChangedEvent selectionChangedEventStub;
    ...
    @Before
    public void setUp() {
        selectionChangedEventStub = new ActivityPanelSelectionChangedEvent(new ActivityCard(ALICE, 0));
