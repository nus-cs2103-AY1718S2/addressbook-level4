...
public class AddressBook implements ReadOnlyAddressBook {
    ...
    private Person syncWithMasterTagList(Person person) {
        ...
        return new Person(
                person.getName(), person.getPhone(), person.getEmail(), person.getAddress(), correctTagReferences, person.getBirthday());
    }
    ...
    */
    private void removeTagFromPerson(Tag tag, Person person) throws PersonNotFoundException {
        ...
        Person newPerson =
                new Person(person.getName(), person.getPhone(), person.getEmail(), person.getAddress(), newTags, person.getBirthday());
        try {
