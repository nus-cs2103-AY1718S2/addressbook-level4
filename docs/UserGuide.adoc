...
Command entered: `edit 2 p/91234567 e/johndoe@example.com` +
This changes the details of the person with index 2 (Betsy Crowe), in this case, her phone number and email address and writes over his original saved details (Figure 14).
...
Command(s) entered: `list` +
Lists all people in Your TA (Figure 20). +
