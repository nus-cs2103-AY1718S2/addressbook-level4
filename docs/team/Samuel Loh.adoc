...
** What it does:
*** The profile page allows the tutor to view a student's full information paticulars on a separate page instead of the student card, which may be too small and straining for the eyes.
