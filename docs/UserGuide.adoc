...
=== Going back on calendar view : `goback` or `gb` `[Coming in v1.5]`

Makes the calendar view go back in time from the currently displaying date. +
Format: `goback` or `gb`
...
=== Going forward on calendar view : `goforward` or `gf` `[Coming in v1.5]`
