...
public class SystemTestSetupHelper {
     ...
     */
    public TestApp setupApplication(Supplier<ReadOnlyCoinBook> coinBook, String saveFileLocation) {
        try {
            FxToolkit.registerStage(Stage::new);
            FxToolkit.setupApplication(() -> testApp = new TestApp(coinBook, saveFileLocation));
