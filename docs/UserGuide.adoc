...
Alias: `a` and `+` +
Format: `add n/NAME m/MATRICULATION NUMBER p/PHONE_NUMBER e/EMAIL a/ADDRESS dp/IMAGE_PATH [t/TAG]...`

[TIP]
A person can have any number of tags (including 0)

[NOTE]
You may leave out `dp/` if you do not wish to add a display picture.
...
* `add n/John Doe m/A0111111X p/98765432 e/johnd@example.com a/John street, block 123, #01-01 dp/C:/display.png`
