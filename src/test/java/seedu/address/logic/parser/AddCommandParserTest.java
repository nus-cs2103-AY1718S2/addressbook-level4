...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Coin expectedCoin = new CoinBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_FRIEND).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedCoin));
        ...
        Coin expectedCoinMultipleTags = new CoinBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Coin expectedCoin = new CoinBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
