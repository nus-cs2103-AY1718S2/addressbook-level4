...
public class XmlAdaptedPersonTest {
    ...
    private static final List<XmlAdaptedSkill> VALID_SKILLS = BENSON.getSkills().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_POSITION,
                        VALID_COMPANY, VALID_PROFILE_PICTURE, VALID_SKILLS);
    ...
    public void toModelType_invalidCompany_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_POSITION,
                        INVALID_COMPANY, VALID_PROFILE_PICTURE, VALID_SKILLS);
    ...
    public void toModelType_nullCompany_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_CURRENT_POSITION, null, VALID_PROFILE_PICTURE, VALID_SKILLS);
    ...
    public void toModelType_invalidProfilePicture_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_POSITION,
                        VALID_COMPANY, INVALID_PROFILE_PICTURE, VALID_SKILLS);
    ...
    public void toModelType_nonExistProfilePicture_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_POSITION,
                        VALID_COMPANY, NON_EXIST_PROFILE_PICTURE, VALID_SKILLS);
    ...
    public void toModelType_invalidSkills_throwsIllegalValueException() {
        List<XmlAdaptedSkill> invalidSkills = new ArrayList<>(VALID_SKILLS);
        invalidSkills.add(new XmlAdaptedSkill(INVALID_SKILL));
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_POSITION,
                        VALID_COMPANY, VALID_PROFILE_PICTURE, invalidSkills);
