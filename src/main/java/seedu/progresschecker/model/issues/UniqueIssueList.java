...
public class UniqueIssueList implements Iterable<Issue> {
     ...
     */
    public void add(Issue toAdd) throws DuplicatePersonException {
    ...
    public void setPersons(seedu.progresschecker.model.person.UniquePersonList replacement) {
        this.internalList.setAll(replacement.internalList);
    }

    public void setPersons(List<Person> persons) throws DuplicatePersonException {
        requireAllNonNull(persons);
        final seedu.progresschecker.model.person.UniquePersonList replacement = new seedu.progresschecker.model.person.UniquePersonList();
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.progresschecker.model.issues.UniqueIssueList // instanceof handles nulls
                && this.internalList.equals(((seedu.progresschecker.model.issues.UniqueIssueList) other).internalList));
    }
