...
After edit command is called, list of new string will be stored into a javascript file and parsed into the
html file called by the function.
...
|Keng Seng |Calendar Feature: Add calendar widget to support many administrative tasks(consultation, attendance) | Advanced Sorting Functionalities: Add advanced sorting functionalities into EduBuddy
