...
public abstract class AddressBookSystemTest {
    ...
    private static final List<String> RESULT_DISPLAY_DEFAULT_STYLE = Arrays.asList("text-input", "text-area");
    private static final List<String> RESULT_DISPLAY_ERROR_STYLE =
            Arrays.asList("text-input", "text-area", ResultDisplay.ERROR_STYLE_CLASS);
