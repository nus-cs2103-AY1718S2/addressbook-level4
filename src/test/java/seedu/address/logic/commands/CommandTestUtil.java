...
public class CommandTestUtil {
    ...
    public static final String INVALID_NRIC_DESC = " " + PREFIX_NRIC + "S1234567@"; // '@' not allowed in nrics
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_DOB_DESC = " " + PREFIX_DOB + "0l/0l/l99l"; // 'l' not allowed for DOBs
    public static final String INVALID_BLOODTYPE_DESC = " " + PREFIX_BLOODTYPE + "A1"; // '1' not allowed in blood types
     ...
     * - the address book and the filtered patient list in the {@code actualModel} remain unchanged
     */
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        // we are unable to defensively copy the model for comparison later, so we can
        // only do so by copying its components.
        Imdb expectedImdb = new Imdb(actualModel.getImdb());
        ...
        try {
            ...
            assertEquals(expectedImdb, actualModel.getImdb());
    ...
    public static void deleteFirstPerson(Model model) {
        ...
        try {
            ...
            throw new AssertionError("Patient in filtered list must exist in model.", pnfe);
        }
    }
