...
image::L1R5CommandSequenceDiagram.png[width="800"]
...
The result will be shown on the `Command Box` in the format: `Deleted Tag: [TAG_NAME]`.

image::TagDeleteCommandSequenceDiagram.png[width="800"]

Figure: Sequence Diagram of TagDeleteCommand if the specified tag exists.
