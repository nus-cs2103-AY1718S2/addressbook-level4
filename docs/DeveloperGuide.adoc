...
** Upgrades the existing `find` command to support finding persons whose details contain
any of the given keywords or part thereof

Major Enhancement :

** Implements an emailing functionality that allows user to email persons in the address book using
existing templates
