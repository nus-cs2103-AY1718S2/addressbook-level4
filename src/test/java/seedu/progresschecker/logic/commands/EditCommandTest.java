...
public class EditCommandTest {
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        // edit person in filtered list into a duplicate in ProgressChecker
        Person personInList = model.getProgressChecker().getPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = prepareCommand(INDEX_FIRST_PERSON,
     ...
     * but smaller than size of ProgressChecker
     */
    @Test
