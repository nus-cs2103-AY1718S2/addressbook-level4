...
* store students' profile information and pictures
...
** This helps the tutor store more information reagarding students in another portion which are not referenced as often and thus do not need to be displayed on the student card.
