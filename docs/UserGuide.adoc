...
Notifications are shown in notification cards in ET. Each notification card contains 3 information about the expiring event: title, name of person in-charge, time of expiry. +
...
image::employeesList.png[width="790"]
