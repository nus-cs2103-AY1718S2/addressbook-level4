...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_ADDED_AMY = "01/01/2018";
    ...
    public static final String DATE_ADDED_DESC_AMY = " " + PREFIX_DATE + VALID_DATE_ADDED_AMY;
     ...
     * - the address book, the filtered person list and the filtered appointment list
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new NameContainsFullKeywordsPredicate(Arrays.asList(splitName[0])));

        assertEquals(1, model.getFilteredPersonList().size());
    }

    /**
     * Deletes the first person in {@code model}'s filtered person list from {@code model}'s address book.
     */
