...
The `Timetable` feature uses the NUSMods website to allow students to add their timetable in the fastest possbile way.
`Timetable` is currently stored as a NUSMods link and within `Person` class.
