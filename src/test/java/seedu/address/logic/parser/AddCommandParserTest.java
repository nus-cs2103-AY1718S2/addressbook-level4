...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        ...
                        + MAJOR_DESC_BOB + RESUME_DESC_BOB
                        + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        ...
                        + MAJOR_DESC_AMY + MAJOR_DESC_BOB + RESUME_DESC_BOB
                        + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + EXPECTED_GRADUATION_YEAR_DESC_BOB + MAJOR_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                ...
                .withTags().build();
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + EXPECTED_GRADUATION_YEAR_DESC_AMY + MAJOR_DESC_AMY + RESUME_DESC_AMY,
                new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + VALID_EXPECTED_GRADUATION_YEAR_BOB + MAJOR_DESC_BOB,
                expectedMessage);

        //missing major prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + EXPECTED_GRADUATION_YEAR_DESC_BOB + VALID_MAJOR_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                + VALID_EXPECTED_GRADUATION_YEAR_BOB + VALID_MAJOR_BOB + VALID_RESUME_AMY,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INVALID_EXPECTED_GRADUATION_YEAR_DESC + MAJOR_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                ExpectedGraduationYear.MESSAGE_EXPECTED_GRADUATION_YEAR_CONSTRAINTS);

        //invalid major
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + EXPECTED_GRADUATION_YEAR_DESC_BOB + INVALID_MAJOR_DESC
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + EXPECTED_GRADUATION_YEAR_DESC_BOB + MAJOR_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
                Tag.MESSAGE_TAG_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                        + EXPECTED_GRADUATION_YEAR_DESC_BOB + MAJOR_DESC_BOB, Name.MESSAGE_NAME_CONSTRAINTS);
