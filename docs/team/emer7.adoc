...
*** Periodically refactor code to reduce coupling https://github.com/CS2103JAN2018-T09-B1/main/issues/111[1], maintain consistency https://github.com/CS2103JAN2018-W15-B1/main/pull/223[2], and introduce more meaningful naming https://github.com/CS2103JAN2018-W15-B1/main/pull/149[3].
** Documentation:
