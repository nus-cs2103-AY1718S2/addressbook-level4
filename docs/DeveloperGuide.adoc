...
(For all use cases below, the *System* is the `ProgressCheck` and the *Actor* is the `user`, unless specified otherwise)
...
2.  ProgressCheck shows content of the specified week
+
Use case ends.
...
+
[none]
** 1a1. ProgressCheck shows an error message.
+
Use case ends.
...
2.  ProgressCheck shows a list of persons
3.  User requests to delete a specific person in the list
4.  ProgressCheck deletes the person
+
Use case ends.
...
+
[none]
** 3a1. ProgressCheck shows an error message.
+
...
2.  ProgressCheck shows tasks in the specified week
3.  User requests to add a new task in a specific week
4.  ProgressCheck adds a new task to the existing list
+
Use case ends.
...
4.  ProgressCheck marks specified task as complete
+
Use case ends.
...
4.  ProgressCheck takes in input and saves
+
Use case ends.
