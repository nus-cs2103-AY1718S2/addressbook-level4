...
** Justification: This feature improves the speed and efficiency to key in the inputs especially for those experienced users who are familiar with the commands.
