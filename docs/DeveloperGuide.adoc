...
image::SDforChangeTheme.png[width="600"]
...
image::SDforChangeThemeDetails.png[width="400"]
...
image::SDforInternetSearch.png[width="600"]
...
image::SDforInternetSearchDetails.png[width="500"]
...
image::InternetSearchClassDiagram.png[width="700"]
