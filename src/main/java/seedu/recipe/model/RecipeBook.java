...
public class RecipeBook implements ReadOnlyRecipeBook {
    ...
    /**
     * Creates an RecipeBook using the Persons and Tags in the {@code toBeCopied}
     */
    ...
    private Person syncWithMasterTagList(Person person) {
        ...
        return new Person(
                person.getName(), person.getPhone(), person.getIngredient(), person.getInstruction(), correctTagReferences);
    }

    /**
     * Removes {@code key} from this {@code RecipeBook}.
     * @throws PersonNotFoundException if the {@code key} is not in this {@code RecipeBook}.
     */
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                ...
                && this.persons.equals(((RecipeBook) other).persons)
