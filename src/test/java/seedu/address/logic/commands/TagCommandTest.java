...
public class TagCommandTest {
    ...
    public void execute_zeroKeywords_noPersonFound() {
        String expectedMessage = String.format(MESSAGE_PERSONS_WITH_TAGS_LISTED_OVERVIEW, 0, null);
    ...
    public void execute_multipleKeywords_multiplePersonsFound() {
        String expectedMessage = String.format(MESSAGE_PERSONS_WITH_TAGS_LISTED_OVERVIEW, 2);
        TagCommand command = prepareCommand("friends owesMoney");
