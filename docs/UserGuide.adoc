...
_{ TODO: To explain what a user feature is. }_
...
Adding a question for password retrieval +
...
_{ TODO: Describe the command function }_
...
_{ TODO: To explain what a task management feature is. }_
_{ TODO: Update the Task Parameters box and update it. }_
_{ TODO: Explain priority levels }_
...
_{ TODO: To explain what a subtask feature is. }_
_{ TODO: Update the subtask parameters. }_
...
_{ TODO: Add a note about display }_

=== Go to current month: `cmonth` or `cm` `[since v1.4]`

Changes the view of the calendar to that of the current month. +
...
_{ TODO: To explain what this feature is about }_
