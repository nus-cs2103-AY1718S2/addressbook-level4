...
:repoURL: https://github.com/kush1509/main/tree/master
...
The application is targeted towards Human Resources Managers at SMEs and start-ups. HR managers have a lot of contacts to manage which include current employees, customers, potential employees, potential customers, investors and many others. It is essential for them to have a quick and easy access to these contacts. Hence, contactHero aims to make their lives easier by helping them to store and manage their contacts efficiently.

*User Profile*:

* HR managers who have a significant number of contacts to manage
* Start-up employee who is new to HR management
* HR managers who prefer desktop apps
* HR managers who are good at typing and hence prefer CLI apps
...
|`* * *` |user |add Linkedin and Github link | view pople's profile
