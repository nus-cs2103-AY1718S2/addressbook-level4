...
This feature allows the user to keep track of participation marks of a `Person`. The participation marks in this case is limited to an integer value of 1 to 100 inclusive. A new class, `Participation`, is created and is associated to the `Person` class.
