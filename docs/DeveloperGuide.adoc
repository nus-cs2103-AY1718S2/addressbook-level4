...
[discrete]
=== Use case: Add policies of a person

*MSS*

1. User requests to list persons.
2. User requests add policy to a specified person in the list
3. App takes in a command the price, dates and issues covered by the policy
4. AddressBook add the specified policy to the person
5. Use case ends

*Extensions*

[none]
* 2a. The index specified does not exist or no index is specified
+
Use case ends.

*3a. Incorrect parameters are specified
+
Use case ends.
