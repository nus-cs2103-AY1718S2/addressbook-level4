...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddCommand aliasedCommand = (AddCommand) parser.parseCommand(PersonUtil.getAddCommand(person));
        assertEquals(new AddCommand(person), aliasedCommand);
    }
    ...
    public void parseCommand_delete() throws Exception {
        ...
        assertEquals(new DeleteCommand(INDEX_FIRST_PERSON), aliasedCommand);
    }
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand aliasedCommand = (EditCommand) parser.parseCommand(EditCommand.COMMAND_ALIAS + " "
                + INDEX_FIRST_PERSON.getOneBased() + " " + PersonUtil.getPersonDetails(person));
        assertEquals(new EditCommand(INDEX_FIRST_PERSON, descriptor), aliasedCommand);
    }
    ...
    public void parseCommand_select() throws Exception {
        ...
        assertEquals(new SelectCommand(INDEX_FIRST_PERSON), aliasedCommand);
    }
