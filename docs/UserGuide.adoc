...
// tag::addCommandExtension[]
=== Adding a person with specific condition and priority: `add` [coming in 2.0]

Adds a person to the address book +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS c/CONDITION pri/PRIORITY_LEVEL [t/TAG]...`
...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 c/Depression pri/4`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 c/Suicidal Tendencies pri/5 t/criminal`
// end::addCommandExtension[]
