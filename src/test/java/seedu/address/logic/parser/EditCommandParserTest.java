...
//        assertParseFailure(parser, "1" + INVALID_PHONE_DESC + EMAIL_DESC_AMY, DateTime.MESSAGE_DATETIME_CONSTRAINTS);
//
//        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
//        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
//        assertParseFailure(parser, "1" + PHONE_DESC_BOB + INVALID_PHONE_DESC, DateTime.MESSAGE_DATETIME_CONSTRAINTS);
//
...
//
//        EditCommand.EditActivityDescriptor descriptor = new EditActivityDescriptorBuilder().withPhone(VALID_PHONE_BOB)
...
//                + PHONE_DESC_BOB;
//        descriptor = new EditActivityDescriptorBuilder().withPhone(VALID_PHONE_BOB)
