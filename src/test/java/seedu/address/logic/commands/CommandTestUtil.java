...
import seedu.address.model.person.NameContainsKeyphrasesPredicate;
...
public class CommandTestUtil {
    ...
    public static final String VALID_REVIEW_LAZY = "supervisor@example.com";
    public static final String VALID_REVIEWER_SUPERVISOR = "Lazy";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withReviews(VALID_REVIEWER_SUPERVISOR + "\n" + VALID_REVIEW_LAZY).build();
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new NameContainsKeyphrasesPredicate(Arrays.asList(splitName[0])));
