...
|`* *` |user | calculator function in the app that allows you to calculate charges
|`* ` |user | split a bill unevenly among multiple people
|`* ` |user | get notified when I get charged a new amount
|`* ` |user | select the currency that I am owed
|`* ` |user | convert my balance into a different currency
|`* ` |user | send reminder to the person who owes me money 
