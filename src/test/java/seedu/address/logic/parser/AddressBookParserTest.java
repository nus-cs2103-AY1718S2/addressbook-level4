...
public class AddressBookParserTest {
    ...
    public void parseCommand_editAlias() throws Exception {
        ...
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_ALIAS + " "
                + OPTION_OWNER + INDEX_FIRST_PERSON.getOneBased() + " " + PersonUtil.getPersonDetails(person));
    ...
    public void parseCommand_findAlias() throws Exception {
        ...
        assertTrue(parser.parseCommand(FindCommand.COMMAND_ALIAS + " -o n/"
                + keywords.stream().collect(Collectors.joining(" "))) instanceof FindCommand);
    }

    @Test
    public void parseCommand_find() throws Exception {
        List<String> keywords = Arrays.asList("foo", "bar", "baz");
        assertTrue(parser.parseCommand(FindCommand.COMMAND_WORD + " -o n/"
                + keywords.stream().collect(Collectors.joining(" "))) instanceof FindCommand);
    }
