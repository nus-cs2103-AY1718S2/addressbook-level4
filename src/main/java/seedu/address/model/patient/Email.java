...
public class Email {
    ...
    public static final String MESSAGE_EMAIL_CONSTRAINTS = "Patient emails should be of the format local-part@domain "
    ...
    /**
     * Returns if a given string is a valid patient email.
     */
