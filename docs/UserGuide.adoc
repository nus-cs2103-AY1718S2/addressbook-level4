...
<1>	Command box: the user types the command here
<2>	Command result: the command result message will be displayed here after a command is entered
<3>	Multipurpose panel: the patient's details and appointments will be displayed here
<4>	Patient list panel: the list of patients in the database is displayed
<5>	Visiting queue panel: the list of patients who are currently waiting for consultation is displayed
