...
include::../UserGuide.adoc[skill=undoredo]

include::../UserGuide.adoc[skill=dataencryption]
...
include::../DeveloperGuide.adoc[skill=undoredo]

include::../DeveloperGuide.adoc[skill=dataencryption]
