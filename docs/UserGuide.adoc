...
. Enter the command `moreInfo 1` if you wish to view the profile page of the 1st student in the current student list. You will see the following below
...
.Example of the command to edit a student's profile picture
