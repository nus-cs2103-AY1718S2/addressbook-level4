...
|`* * *` |user |filter a student by field |locate details of students in a more optimized view
...
|`* * *` |user |edit a student's status |indicate whether students are still being considered or rejected

|`* * *` |user |add a remark |update additional information about the student

|`* * *` |user |add a rating |evaluate the performance of the student after an interview
