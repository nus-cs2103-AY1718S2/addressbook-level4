...
A single add command with options to add a contact, pet patient and appointment to Medeina. Users don't have to remember multiple commands performing similar functions. Also able to add all 3 objects in a single command to reduce typing.
