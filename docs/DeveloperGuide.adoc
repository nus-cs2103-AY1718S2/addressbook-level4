...
* **Alternative 1 (current choice):** Implement a new command class `RateCommand` that supports both adding and editing rating scores
** Pros: Results in a more customisable command that can be easily modified to support more prefixes and additional rating criteria
