...
*A*:
****
When adding or editing a person, you can input his/her NUSMods shortened link in the tt/TIMETABLE field
.   Go to NUSMods
.   Click `Share/Sync` at the bottom right hand corner
image::NUSMods_SS1.png[width="800"]
.   Copy the link in the window that appeared
image::NUSMods_SS2.png[width="800"]
