...
==== Viewing the schedule for doctors across all specialists `[coming in v2.0]`

IMDB will be able to view the schedule for doctors across all specialists so that medical staff can make arrangements if patient specifies which doctor he or she would like to visit for the appointment.
