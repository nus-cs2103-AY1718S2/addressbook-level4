...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [ti/TIMEZONE] [t/TAG]...`
Alias: `a`
...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 ti/SGT`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [ti/TIMEZONE] [t/TAG]...`
Alias: `e`
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [ti/TIMEZONE] [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 ti/SGT t/friend t/colleague`
