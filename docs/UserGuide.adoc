...
An encrypted or unencrypted ST instance from filepath to the existing ST application. Persons, Tags, and Aliases that are not in your ST will be added. +
...
== Upcoming Features
=== Use current location to find vacant rooms
