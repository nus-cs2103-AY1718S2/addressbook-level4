...
```
###### /java/seedu/flashy/logic/parser/ChangeThemeCommandParserTest.java
``` java
...
```
###### /java/seedu/flashy/logic/parser/SelectCardCommandParserTest.java
``` java
/**
...
```
###### /java/seedu/flashy/logic/parser/ParserUtilTest.java
``` java
    @Test
...
```
###### /java/seedu/flashy/logic/commands/ChangeThemeCommandTest.java
``` java
...
```
###### /java/seedu/flashy/logic/commands/SelectCardCommandTest.java
``` java
