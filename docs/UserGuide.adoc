...
|*AddRemark* |Adds a remark to a specific student|`addremark 1 r/REMARK` |addremark 1 r/English Rep
...
|*DeleteRemark* |Deletes a remark from a specific student|`deleteremark 1 r/REMARK` |deleteremark 1 r/English Rep
