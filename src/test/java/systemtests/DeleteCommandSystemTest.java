...
public class DeleteCommandSystemTest extends ProgressCheckerSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered person list, delete index within bounds of ProgressChecker and person list -> deleted */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        Index index = INDEX_FIRST_PERSON;
        assertTrue(index.getZeroBased() < getModel().getFilteredPersonList().size());
        assertCommandSuccess(index);

        /* Case: filtered person list, delete index within bounds of ProgressChecker but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getProgressChecker().getPersonList().size() + 1);
    ...
    /**
     * Removes the {@code Person} at the specified {@code index} in {@code model}'s ProgressChecker.
