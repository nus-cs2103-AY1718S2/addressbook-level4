...
Note: Dates can be written in natural language (e.g. Today, This Friday, May 4, etc.)
...
Note: Date can be written in natural language (e.g. Today, This Friday, May 4, etc.)
