...
/**
 * Provides a handle for {@code SearchResultsPanel} containing the list of {@code Book}.
 */
public class SearchResultsPanelHandle extends NodeHandle<ListView<Book>> {
    ...
    public SearchResultsPanelHandle(ListView<Book> searchResultsPanelNode) {
