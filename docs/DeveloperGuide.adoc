...
1.  User inputs login command word, username and password
2.  IMDB shows a success message
+
Use case ends
...
** 1a2. User inputs login command word, username and password
** Steps 1a1-1a2 are repeated until username and password match
+
Use case resumes at step 2
[none]
* 1b. User is already logged in
+
[none]
** 1b1. IMDB shows an error message
** 1b2. User enters exit command and restarts IMDB
+
